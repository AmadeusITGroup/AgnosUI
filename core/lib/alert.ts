import type {CommonAlertApi, CommonAlertDirectives, CommonAlertProps, CommonAlertState} from './commonAlert';
import {createCommonAlert, getCommonAlertDefaultConfig} from './commonAlert';
import type {ExtendWidgetAdaptSlotWidgetProps} from './extendWidget';
import {extendWidgetProps} from './extendWidget';
import type {ConfigValidator} from './services';
