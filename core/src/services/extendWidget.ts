...
export type ExtendWidgetProps<W extends Widget, ExtraProps extends object, ExtraDirectives extends object = object> = Widget<
	ExtendWidgetAdaptSlotWidgetProps<WidgetProps<W>, ExtraProps, ExtraDirectives>, // do we need to have the ExtraInterfaces here?
 ...
 */
export type ExtendWidgetAdaptSlotContentProps<
