...
/**
 * Represents a context widget by picking specific properties from a given widget type.
 *
 * @template W - The type of the widget from which properties are picked.
 *
 * The picked properties include:
 * - `actions`: The actions associated with the widget.
 * - `api`: The API interface of the widget.
 * - `directives`: The directives used by the widget.
 * - `state$`: The observable state of the widget.
 * - `stores`: The stores associated with the widget.
 */
...
/**
 * Converts a given widget into a context widget.
 *
 * @template W - The type of the widget.
 * @param w - The widget to be converted.
 * @returns The context widget containing the actions, api, directives, state$, and stores of the given widget.
 */
