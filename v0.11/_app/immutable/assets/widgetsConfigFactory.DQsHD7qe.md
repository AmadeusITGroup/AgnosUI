...
Defined in: [svelte/headless/src/config.ts:26](https://github.com/quentinderoubaix/AgnosUI/blob/7ff6d5c23e95a078ba74f1c16e3d6e3aca197427/svelte/headless/src/config.ts#L26)
...
> **getContextWidgetConfig**: \<`N`\>(`widgetName`) => [`ReadableSignal`](https://amadeusitgroup.github.io/tansu/interfaces/ReadableSignal.html)\<[`Partial`](https://www.typescriptlang.org/docs/handbook/utility-types.html#partialtype)\<`Config`\[`N`\]\> \| `undefined`\>
