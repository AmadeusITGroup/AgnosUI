...
Defined in: [react/headless/src/config.tsx:25](https://github.com/quentinderoubaix/AgnosUI/blob/63685e6607529b4571cb9fcf72f83fa7e63d14bc/react/headless/src/config.tsx#L25)
...
`Context`\<[`WidgetsConfigStore`](../type-aliases/WidgetsConfigStore.md)\<`Config`\> \| `undefined`\> = `...`
...
> **WidgetsConfigContext**: `Context`\<[`WidgetsConfigStore`](../type-aliases/WidgetsConfigStore.md)\<`Config`\> \| `undefined`\>
