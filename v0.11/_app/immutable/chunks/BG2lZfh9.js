const e=`import { widgetsConfigFactory, SlotDirective, UseDirective, ComponentTemplate, BaseWidgetDirective, auBooleanAttribute, UseMultiDirective, auNumberAttribute, useDirectiveForHost, callWidgetFactory as callWidgetFactory$1, ToasterService as ToasterService$1, auNumberOrNullAttribute } from '@agnos-ui/angular-headless';
export * from '@agnos-ui/angular-headless';
import * as i0 from '@angular/core';
import { InjectionToken, inject, TemplateRef, Directive, viewChild, Component, input, contentChild, output, ViewEncapsulation, forwardRef, Injector, runInInjectionContext, Service, computed, effect, NgModule, ApplicationRef, createComponent, outputBinding, inputBinding, EnvironmentInjector } from '@angular/core';
...
function ModalComponent_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵproperty("auUseMulti", i0.ɵɵpureFunction2(1, _c5$3, ctx_r0.directives.backdropPortalDirective, ctx_r0.directives.backdropDirective));
} }
...
function ModalComponent_Conditional_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r0 = i0.ɵɵnextContext();
    i0.ɵɵproperty("auUseMulti", i0.ɵɵpureFunction2(6, _c5$3, ctx_r0.directives.modalPortalDirective, ctx_r0.directives.modalDirective));
    i0.ɵɵadvance();
...
class ModalDefaultSlotsComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ModalDefaultSlotsComponent, selectors: [["ng-component"]], viewQuery: function ModalDefaultSlotsComponent_Query(rf, ctx) { if (rf & 1) {
            i0.ɵɵviewQuerySignal(ctx.header, _c0$b, 5)(ctx.structure, _c1$a, 5);
        } if (rf & 2) {
            i0.ɵɵqueryAdvance(2);
        ...
        } }, dependencies: [SlotDirective, ModalHeaderDirective, ModalStructureDirective, UseDirective], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(ModalDefaultSlotsComponent, { className: "ModalDefaultSlotsComponent", filePath: "components/modal/modal.component.ts", lineNumber: 99 }); })();
/**
...
class ModalComponent extends BaseWidgetDirective {
    constructor() {
         ...
         * @defaultValue \`true\`
         */
        this.animated = input(undefined, { ...(ngDevMode ? { debugName: "animated" } : /* istanbul ignore next */ {}), alias: 'auAnimated', transform: auBooleanAttribute });
        /**
         * The transition to use for the backdrop behind the modal (if present).
         *
         * @defaultValue \`fadeTransition\`
         */
        this.backdropTransition = input(undefined, { ...(ngDevMode ? { debugName: "backdropTransition" } : /* istanbul ignore next */ {}), alias: 'auBackdropTransition' });
        /**
         * The transition to use for the modal.
         *
         * @defaultValue \`fadeTransition\`
         */
        this.modalTransition = input(undefined, { ...(ngDevMode ? { debugName: "modalTransition" } : /* istanbul ignore next */ {}), alias: 'auModalTransition' });
        /**
         * Whether the modal should be visible when the transition is completed.
         *
         * @defaultValue \`false\`
         */
        this.visible = input(undefined, { ...(ngDevMode ? { debugName: "visible" } : /* istanbul ignore next */ {}), alias: 'auVisible', transform: auBooleanAttribute });
        /**
         * Whether a backdrop should be created behind the modal.
         *
         * @defaultValue \`true\`
         */
        this.backdrop = input(undefined, { ...(ngDevMode ? { debugName: "backdrop" } : /* istanbul ignore next */ {}), alias: 'auBackdrop', transform: auBooleanAttribute });
        /**
         * Whether the modal should be closed when clicking on the viewport outside the modal.
         *
         * @defaultValue \`true\`
         */
        this.closeOnOutsideClick = input(undefined, { ...(ngDevMode ? { debugName: "closeOnOutsideClick" } : /* istanbul ignore next */ {}), alias: 'auCloseOnOutsideClick', transform: auBooleanAttribute });
        /**
         ...
         * \`\`\`
         */
        this.container = input(undefined, { ...(ngDevMode ? { debugName: "container" } : /* istanbul ignore next */ {}), alias: 'auContainer' });
        /**
         * Value of the aria-label attribute to put on the close button.
         *
         * @defaultValue \`'Close'\`
         */
        this.ariaCloseButtonLabel = input(undefined, { ...(ngDevMode ? { debugName: "ariaCloseButtonLabel" } : /* istanbul ignore next */ {}), alias: 'auAriaCloseButtonLabel' });
        /**
         * Classes to add on the backdrop DOM element.
         *
         * @defaultValue \`''\`
         */
        this.backdropClass = input(undefined, { ...(ngDevMode ? { debugName: "backdropClass" } : /* istanbul ignore next */ {}), alias: 'auBackdropClass' });
        /**
         * Whether to display the close button.
         *
         * @defaultValue \`true\`
         */
        this.closeButton = input(undefined, { ...(ngDevMode ? { debugName: "closeButton" } : /* istanbul ignore next */ {}), alias: 'auCloseButton', transform: auBooleanAttribute });
        /**
         * CSS classes to be applied on the widget main container
         *
         * @defaultValue \`''\`
         */
        this.className = input(undefined, { ...(ngDevMode ? { debugName: "className" } : /* istanbul ignore next */ {}), alias: 'auClassName' });
        /**
         * Option to create a fullscreen modal, according to the bootstrap documentation.
         *
         * @defaultValue \`false\`
         */
        this.fullscreen = input(undefined, { ...(ngDevMode ? { debugName: "fullscreen" } : /* istanbul ignore next */ {}), alias: 'auFullscreen', transform: auBooleanAttribute });
        /**
         ...
         */
        this.structure = input(undefined, { ...(ngDevMode ? { debugName: "structure" } : /* istanbul ignore next */ {}), alias: 'auStructure' });
        this.slotStructureFromContent = contentChild(ModalStructureDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Header of the modal. The default header includes {@link ModalProps.title|title}.
         */
        this.header = input(undefined, { ...(ngDevMode ? { debugName: "header" } : /* istanbul ignore next */ {}), alias: 'auHeader' });
        this.slotHeaderFromContent = contentChild(ModalHeaderDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotHeaderFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Title of the modal.
         */
        this.title = input(undefined, { ...(ngDevMode ? { debugName: "title" } : /* istanbul ignore next */ {}), alias: 'auTitle' });
        this.slotTitleFromContent = contentChild(ModalTitleDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotTitleFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Body of the modal.
         */
        this.children = input(undefined, { ...(ngDevMode ? { debugName: "children" } : /* istanbul ignore next */ {}), alias: 'auChildren' });
        this.slotDefaultFromContent = contentChild(ModalBodyDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotDefaultFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Footer of the modal.
         */
        this.footer = input(undefined, { ...(ngDevMode ? { debugName: "footer" } : /* istanbul ignore next */ {}), alias: 'auFooter' });
        this.slotFooterFromContent = contentChild(ModalFooterDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotFooterFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Data to use in content slots
         */
        this.contentData = input(undefined, { ...(ngDevMode ? { debugName: "contentData" } : /* istanbul ignore next */ {}), alias: 'auContentData' });
        /**
        ...
        this.slotChildren = viewChild('content', /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotChildren" }] : /* istanbul ignore next */ []));
    }
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ModalComponent, selectors: [["", "auModal", ""]], contentQueries: function ModalComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        } }, dependencies: [UseMultiDirective, SlotDirective], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(ModalComponent, { className: "ModalComponent", filePath: "components/modal/modal.component.ts", lineNumber: 136 }); })();
...
const _c5$2 = (a0, a1, a2, a3) => ({ state: a0, api: a1, directives: a2, displayedPage: a3 });
...
function PaginationDefaultSlotsComponent_ng_template_0_For_1_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const api_r3 = ctx_r0.api;
    const directives_r4 = ctx_r0.directives;
    i0.ɵɵproperty("auUse", i0.ɵɵpureFunction2(6, _c4$6, directives_r4.pageLink, i0.ɵɵpureFunction1(4, _c3$8, page_r5)));
    i0.ɵɵadvance();
    i0.ɵɵproperty("auSlot", state_r2.numberLabel())("auSlotProps", i0.ɵɵpureFunction4(9, _c5$2, state_r2, api_r3, directives_r4, page_r5));
    i0.ɵɵadvance();
...
class PaginationDefaultSlotsComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: PaginationDefaultSlotsComponent, selectors: [["ng-component"]], viewQuery: function PaginationDefaultSlotsComponent_Query(rf, ctx) { if (rf & 1) {
            i0.ɵɵviewQuerySignal(ctx.pages, _c0$a, 5)(ctx.structure, _c1$9, 5);
        } if (rf & 2) {
            i0.ɵɵqueryAdvance(2);
        ...
        } }, dependencies: [SlotDirective, PaginationPagesDirective, PaginationStructureDirective, UseDirective], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(PaginationDefaultSlotsComponent, { className: "PaginationDefaultSlotsComponent", filePath: "components/pagination/pagination.component.ts", lineNumber: 170 }); })();
/**
...
class PaginationComponent extends BaseWidgetDirective {
    constructor() {
         ...
         * \`\`\`
         */
        this.ariaPageLabel = input(undefined, { ...(ngDevMode ? { debugName: "ariaPageLabel" } : /* istanbul ignore next */ {}), alias: 'auAriaPageLabel' });
        /**
         ...
         * \`\`\`
         */
        this.ariaLiveLabel = input(undefined, { ...(ngDevMode ? { debugName: "ariaLiveLabel" } : /* istanbul ignore next */ {}), alias: 'auAriaLiveLabel' });
        /**
         ...
         */
        this.ariaLabel = input(undefined, { ...(ngDevMode ? { debugName: "ariaLabel" } : /* istanbul ignore next */ {}), alias: 'auAriaLabel' });
        /**
         ...
         * \`\`\`
         */
        this.activeLabel = input(undefined, { ...(ngDevMode ? { debugName: "activeLabel" } : /* istanbul ignore next */ {}), alias: 'auActiveLabel' });
        /**
         ...
         * \`\`\`
         */
        this.ariaFirstLabel = input(undefined, { ...(ngDevMode ? { debugName: "ariaFirstLabel" } : /* istanbul ignore next */ {}), alias: 'auAriaFirstLabel' });
        /**
         ...
         * \`\`\`
         */
        this.ariaPreviousLabel = input(undefined, { ...(ngDevMode ? { debugName: "ariaPreviousLabel" } : /* istanbul ignore next */ {}), alias: 'auAriaPreviousLabel' });
        /**
         ...
         * \`\`\`
         */
        this.ariaNextLabel = input(undefined, { ...(ngDevMode ? { debugName: "ariaNextLabel" } : /* istanbul ignore next */ {}), alias: 'auAriaNextLabel' });
        /**
         ...
         * \`\`\`
         */
        this.ariaLastLabel = input(undefined, { ...(ngDevMode ? { debugName: "ariaLastLabel" } : /* istanbul ignore next */ {}), alias: 'auAriaLastLabel' });
        /**
         ...
         */
        this.ariaEllipsisLabel = input(undefined, { ...(ngDevMode ? { debugName: "ariaEllipsisLabel" } : /* istanbul ignore next */ {}), alias: 'auAriaEllipsisLabel' });
        /**
         ...
         * \`\`\`
         */
        this.pageLink = input(undefined, { ...(ngDevMode ? { debugName: "pageLink" } : /* istanbul ignore next */ {}), alias: 'auPageLink' });
        /**
         ...
         * @defaultValue \`'…'\`
         */
        this.ellipsisLabel = input(undefined, { ...(ngDevMode ? { debugName: "ellipsisLabel" } : /* istanbul ignore next */ {}), alias: 'auEllipsisLabel' });
        this.slotEllipsisFromContent = contentChild(PaginationEllipsisDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotEllipsisFromContent" }] : /* istanbul ignore next */ []));
        /**
         ...
         * @defaultValue \`'«'\`
         */
        this.firstPageLabel = input(undefined, { ...(ngDevMode ? { debugName: "firstPageLabel" } : /* istanbul ignore next */ {}), alias: 'auFirstPageLabel' });
        this.slotFirstFromContent = contentChild(PaginationFirstDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotFirstFromContent" }] : /* istanbul ignore next */ []));
        /**
         ...
         * @defaultValue \`'‹'\`
         */
        this.previousPageLabel = input(undefined, { ...(ngDevMode ? { debugName: "previousPageLabel" } : /* istanbul ignore next */ {}), alias: 'auPreviousPageLabel' });
        this.slotPreviousFromContent = contentChild(PaginationPreviousDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotPreviousFromContent" }] : /* istanbul ignore next */ []));
        /**
         ...
         * @defaultValue \`'›'\`
         */
        this.nextPageLabel = input(undefined, { ...(ngDevMode ? { debugName: "nextPageLabel" } : /* istanbul ignore next */ {}), alias: 'auNextPageLabel' });
        this.slotNextFromContent = contentChild(PaginationNextDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotNextFromContent" }] : /* istanbul ignore next */ []));
        /**
         ...
         * @defaultValue \`'»'\`
         */
        this.lastPageLabel = input(undefined, { ...(ngDevMode ? { debugName: "lastPageLabel" } : /* istanbul ignore next */ {}), alias: 'auLastPageLabel' });
        this.slotLastFromContent = contentChild(PaginationLastDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotLastFromContent" }] : /* istanbul ignore next */ []));
        /**
         * The template to use for the pages slot
         * To use to customize the pages view
         * override any configuration parameters provided for this
         */
        this.pagesDisplay = input(undefined, { ...(ngDevMode ? { debugName: "pagesDisplay" } : /* istanbul ignore next */ {}), alias: 'auPagesDisplay' });
        this.slotPagesFromContent = contentChild(PaginationPagesDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotPagesFromContent" }] : /* istanbul ignore next */ []));
        /**
         ...
         * \`\`\`
         */
        this.numberLabel = input(undefined, { ...(ngDevMode ? { debugName: "numberLabel" } : /* istanbul ignore next */ {}), alias: 'auNumberLabel' });
        this.slotNumberLabelFromContent = contentChild(PaginationNumberDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotNumberLabelFromContent" }] : /* istanbul ignore next */ []));
        /**
         ...
         */
        this.structure = input(undefined, { ...(ngDevMode ? { debugName: "structure" } : /* istanbul ignore next */ {}), alias: 'auStructure' });
        this.slotStructureFromContent = contentChild(PaginationStructureDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        /**
         ...
         * @defaultValue \`false\`
         */
        this.disabled = input(undefined, { ...(ngDevMode ? { debugName: "disabled" } : /* istanbul ignore next */ {}), alias: 'auDisabled', transform: auBooleanAttribute });
        /**
         * If \`true\`, the "First" and "Last" page links are shown.
         *
         * @defaultValue \`false\`
         */
        this.boundaryLinks = input(undefined, { ...(ngDevMode ? { debugName: "boundaryLinks" } : /* istanbul ignore next */ {}), alias: 'auBoundaryLinks', transform: auBooleanAttribute });
        /**
         * If \`true\`, the "Next" and "Previous" page links are shown.
         *
         * @defaultValue \`true\`
         */
        this.directionLinks = input(undefined, { ...(ngDevMode ? { debugName: "directionLinks" } : /* istanbul ignore next */ {}), alias: 'auDirectionLinks', transform: auBooleanAttribute });
        /**
         ...
         * @defaultValue \`0\`
         */
        this.collectionSize = input(undefined, { ...(ngDevMode ? { debugName: "collectionSize" } : /* istanbul ignore next */ {}), alias: 'auCollectionSize', transform: auNumberAttribute });
        /**
         * The current page.
         *
         ...
         * @defaultValue \`1\`
         */
        this.page = input(undefined, { ...(ngDevMode ? { debugName: "page" } : /* istanbul ignore next */ {}), alias: 'auPage', transform: auNumberAttribute });
        /**
         ...
         * @defaultValue \`10\`
         */
        this.pageSize = input(undefined, { ...(ngDevMode ? { debugName: "pageSize" } : /* istanbul ignore next */ {}), alias: 'auPageSize', transform: auNumberAttribute });
        /**
         ...
         * @defaultValue \`null\`
         */
        this.size = input(undefined, { ...(ngDevMode ? { debugName: "size" } : /* istanbul ignore next */ {}), alias: 'auSize' });
        /**
         ...
         * \`\`\`
         */
        this.pagesFactory = input(undefined, { ...(ngDevMode ? { debugName: "pagesFactory" } : /* istanbul ignore next */ {}), alias: 'auPagesFactory' });
        /**
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(PaginationComponent, { className: "PaginationComponent", filePath: "components/pagination/pagination.component.ts", lineNumber: 197 }); })();
...
function RatingComponent_For_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance();
    i0.ɵɵproperty("auUse", i0.ɵɵpureFunction2(6, _c1$8, ctx_r1.directives.starDirective, i0.ɵɵpureFunction1(4, _c0$9, ɵ$index_1_r1)));
    i0.ɵɵadvance();
...
class RatingComponent extends BaseWidgetDirective {
    ...
    constructor() {
         ...
         * \`\`\`
         */
        this.ariaValueTextFn = input(undefined, { ...(ngDevMode ? { debugName: "ariaValueTextFn" } : /* istanbul ignore next */ {}), alias: 'auAriaValueTextFn' });
        /**
         ...
         * @defaultValue \`10\`
         */
        this.maxRating = input(undefined, { ...(ngDevMode ? { debugName: "maxRating" } : /* istanbul ignore next */ {}), alias: 'auMaxRating', transform: auNumberAttribute });
        /**
         * The current rating. Could be a decimal value like \`3.75\`.
         *
         * @defaultValue \`0\`
         */
        this.rating = input(undefined, { ...(ngDevMode ? { debugName: "rating" } : /* istanbul ignore next */ {}), alias: 'auRating', transform: auNumberAttribute });
        /**
         * If \`true\`, the rating can't be changed.
         *
         * @defaultValue \`false\`
         */
        this.readonly = input(undefined, { ...(ngDevMode ? { debugName: "readonly" } : /* istanbul ignore next */ {}), alias: 'auReadonly', transform: auBooleanAttribute });
        /**
         ...
         * @defaultValue \`true\`
         */
        this.resettable = input(undefined, { ...(ngDevMode ? { debugName: "resettable" } : /* istanbul ignore next */ {}), alias: 'auResettable', transform: auBooleanAttribute });
        /**
         ...
         * \`\`\`
         */
        this.star = input(undefined, { ...(ngDevMode ? { debugName: "star" } : /* istanbul ignore next */ {}), alias: 'auStar' });
        this.slotStarFromContent = contentChild(RatingStarDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotStarFromContent" }] : /* istanbul ignore next */ []));
        /**
         ...
         * @defaultValue \`0\`
         */
        this.tabindex = input(undefined, { ...(ngDevMode ? { debugName: "tabindex" } : /* istanbul ignore next */ {}), alias: 'auTabindex', transform: auNumberAttribute });
        /**
         * CSS classes to be applied on the widget main container
         *
         * @defaultValue \`''\`
         ...
         * @defaultValue \`''\`
         */
        this.ariaLabelledBy = input(undefined, { ...(ngDevMode ? { debugName: "ariaLabelledBy" } : /* istanbul ignore next */ {}), alias: 'auAriaLabelledBy' });
        /**
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(RatingComponent, { className: "RatingComponent", filePath: "components/rating/rating.component.ts", lineNumber: 52 }); })();
...
class AlertDefaultSlotsComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: AlertDefaultSlotsComponent, selectors: [["ng-component"]], viewQuery: function AlertDefaultSlotsComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [SlotDirective, AlertStructureDirective], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(AlertDefaultSlotsComponent, { className: "AlertDefaultSlotsComponent", filePath: "components/alert/alert.component.ts", lineNumber: 46 }); })();
/**
...
class AlertComponent extends BaseWidgetDirective {
    constructor() {
         ...
         */
        this.type = input(undefined, { ...(ngDevMode ? { debugName: "type" } : /* istanbul ignore next */ {}), alias: 'auType' });
        /**
         ...
         * @defaultValue \`true\`
         */
        this.dismissible = input(undefined, { ...(ngDevMode ? { debugName: "dismissible" } : /* istanbul ignore next */ {}), alias: 'auDismissible', transform: auBooleanAttribute });
        /**
         ...
         * @defaultValue \`fadeTransition\`
         */
        this.transition = input(undefined, { ...(ngDevMode ? { debugName: "transition" } : /* istanbul ignore next */ {}), alias: 'auTransition' });
        /**
         ...
         * @defaultValue \`false\`
         */
        this.animatedOnInit = input(undefined, { ...(ngDevMode ? { debugName: "animatedOnInit" } : /* istanbul ignore next */ {}), alias: 'auAnimatedOnInit', transform: auBooleanAttribute });
        /**
         ...
         */
        this.children = input(undefined, { ...(ngDevMode ? { debugName: "children" } : /* istanbul ignore next */ {}), alias: 'auChildren' });
        this.slotDefaultFromContent = contentChild(AlertBodyDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotDefaultFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Global template for the alert component
         */
        this.structure = input(undefined, { ...(ngDevMode ? { debugName: "structure" } : /* istanbul ignore next */ {}), alias: 'auStructure' });
        this.slotStructureFromContent = contentChild(AlertStructureDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        /**
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: AlertComponent, selectors: [["", "auAlert", ""]], contentQueries: function AlertComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
            ...
            i0.ɵɵqueryAdvance();
        } }, inputs: { type: [1, "auType", "type"], dismissible: [1, "auDismissible", "dismissible"], transition: [1, "auTransition", "transition"], visible: [1, "auVisible", "visible"], animatedOnInit: [1, "auAnimatedOnInit", "animatedOnInit"], animated: [1, "auAnimated", "animated"], ariaCloseButtonLabel: [1, "auAriaCloseButtonLabel", "ariaCloseButtonLabel"], children: [1, "auChildren", "children"], structure: [1, "auStructure", "structure"], className: [1, "auClassName", "className"] }, outputs: { visibleChange: "auVisibleChange", hidden: "auHidden", shown: "auShown" }, features: [i0.ɵɵInheritDefinitionFeature], ngContentSelectors: _c3$7, decls: 3, vars: 1, consts: [["content", ""], ["role", "alert", 3, "auUse", "class"], ["role", "alert", 3, "auUse"], [3, "auSlot", "auSlotProps"]], template: function AlertComponent_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵprojectionDef();
        ...
        } }, dependencies: [SlotDirective, UseDirective], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(AlertComponent, { className: "AlertComponent", filePath: "components/alert/alert.component.ts", lineNumber: 80 }); })();
...
const _c2$6 = ["content"];
const _c3$6 = ["*"];
const _c4$5 = (a0, a1, a2) => ({ state: a0, api: a1, directives: a2 });
...
class AccordionItemDefaultSlotsComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: AccordionItemDefaultSlotsComponent, selectors: [["ng-component"]], viewQuery: function AccordionItemDefaultSlotsComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [UseDirective, SlotDirective, NgTemplateOutlet, AccordionItemStructureDirective], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(AccordionItemDefaultSlotsComponent, { className: "AccordionItemDefaultSlotsComponent", filePath: "components/accordion/accordion.component.ts", lineNumber: 138 }); })();
/**
...
class AccordionItemComponent extends BaseWidgetDirective {
    constructor() {
         ...
         */
        this.header = input(undefined, { ...(ngDevMode ? { debugName: "header" } : /* istanbul ignore next */ {}), alias: 'auHeader' });
        this.slotHeaderFromContent = contentChild(AccordionHeaderDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotHeaderFromContent" }] : /* istanbul ignore next */ []));
        /**
         ...
         */
        this.children = input(undefined, { ...(ngDevMode ? { debugName: "children" } : /* istanbul ignore next */ {}), alias: 'auChildren' });
        this.slotBodyFromContent = contentChild(AccordionBodyDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotBodyFromContent" }] : /* istanbul ignore next */ []));
        /**
         ...
         */
        this.structure = input(undefined, { ...(ngDevMode ? { debugName: "structure" } : /* istanbul ignore next */ {}), alias: 'auStructure' });
        this.slotStructureFromContent = contentChild(AccordionItemStructureDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        /**
         * The id of the accordion-item. It can be used for controlling the accordion-item via the accordion api.
         */
        this.id = input(undefined, { ...(ngDevMode ? { debugName: "id" } : /* istanbul ignore next */ {}), alias: 'auId' });
        /**
         ...
         */
        this.destroyOnHide = input(undefined, { ...(ngDevMode ? { debugName: "destroyOnHide" } : /* istanbul ignore next */ {}), alias: 'auDestroyOnHide', transform: auBooleanAttribute });
        /**
         ...
         */
        this.headerClassName = input(undefined, { ...(ngDevMode ? { debugName: "headerClassName" } : /* istanbul ignore next */ {}), alias: 'auHeaderClassName' });
        /**
         * CSS classes to add on the accordion-item collapse DOM element.
         */
        this.buttonClassName = input(undefined, { ...(ngDevMode ? { debugName: "buttonClassName" } : /* istanbul ignore next */ {}), alias: 'auButtonClassName' });
        /**
         * CSS classes to add on the accordion-item body container DOM element.
         * The accordion-item body container is the DOM element on what the itemTransition is applied.
         */
        this.bodyContainerClassName = input(undefined, { ...(ngDevMode ? { debugName: "bodyContainerClassName" } : /* istanbul ignore next */ {}), alias: 'auBodyContainerClassName' });
        /**
         * CSS classes to add on the accordion-item body DOM element.
         */
        this.bodyClassName = input(undefined, { ...(ngDevMode ? { debugName: "bodyClassName" } : /* istanbul ignore next */ {}), alias: 'auBodyClassName' });
        /**
         * The html heading level to use for the accordion-item-header.
         */
        this.headingLevel = input(undefined, { ...(ngDevMode ? { debugName: "headingLevel" } : /* istanbul ignore next */ {}), alias: 'auHeadingLevel' });
        /**
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: AccordionItemComponent, selectors: [["", "auAccordionItem", ""]], contentQueries: function AccordionItemComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
            ...
            i0.ɵɵadvance(2);
            i0.ɵɵproperty("auSlotProps", i0.ɵɵpureFunction3(2, _c4$5, ctx.state, ctx.api, ctx.directives))("auSlot", ctx.state.structure());
        } }, dependencies: [SlotDirective], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(AccordionItemComponent, { className: "AccordionItemComponent", filePath: "components/accordion/accordion.component.ts", lineNumber: 167 }); })();
/**
...
class AccordionDirective extends BaseWidgetDirective {
    constructor() {
         ...
         * @defaultValue \`false\`
         */
        this.closeOthers = input(undefined, { ...(ngDevMode ? { debugName: "closeOthers" } : /* istanbul ignore next */ {}), alias: 'auCloseOthers', transform: auBooleanAttribute });
        /**
         * CSS classes to be applied on the widget main container
         *
         * @defaultValue \`''\`
         ...
         * @defaultValue \`true\`
         */
        this.itemDestroyOnHide = input(undefined, { ...(ngDevMode ? { debugName: "itemDestroyOnHide" } : /* istanbul ignore next */ {}), alias: 'auItemDestroyOnHide', transform: auBooleanAttribute });
        /**
         * If \`true\`, accordion-item will be animated.
         *
         * @defaultValue \`true\`
         */
        this.itemAnimated = input(undefined, { ...(ngDevMode ? { debugName: "itemAnimated" } : /* istanbul ignore next */ {}), alias: 'auItemAnimated', transform: auBooleanAttribute });
        /**
         * The transition to use for the accordion-item body-container when the accordion-item is toggled.
         *
         * @defaultValue
         ...
         * \`\`\`
         */
        this.itemTransition = input(undefined, { ...(ngDevMode ? { debugName: "itemTransition" } : /* istanbul ignore next */ {}), alias: 'auItemTransition' });
        /**
         * Structure of the accordion-item. The default item structure is: accordion-item
         * contains accordion header and accordion-item body container; the accordion header contains the accordion button
         * (that contains \`header\`), while the accordion-item body container contains the accordion body (that contains \`children\`).
         ...
         * It is a prop of the accordion-item.
         */
        this.itemStructure = input(undefined, { ...(ngDevMode ? { debugName: "itemStructure" } : /* istanbul ignore next */ {}), alias: 'auItemStructure' });
        /**
         * CSS classes to add on the accordion-item DOM element.
         *
         * @defaultValue \`''\`
         */
        this.itemClassName = input(undefined, { ...(ngDevMode ? { debugName: "itemClassName" } : /* istanbul ignore next */ {}), alias: 'auItemClassName' });
        /**
         * CSS classes to add on the accordion-item header DOM element.
         *
         * @defaultValue \`''\`
         */
        this.itemHeaderClassName = input(undefined, { ...(ngDevMode ? { debugName: "itemHeaderClassName" } : /* istanbul ignore next */ {}), alias: 'auItemHeaderClassName' });
        /**
         * CSS classes to add on the accordion-item toggle button DOM element.
         *
         * @defaultValue \`''\`
         */
        this.itemButtonClassName = input(undefined, { ...(ngDevMode ? { debugName: "itemButtonClassName" } : /* istanbul ignore next */ {}), alias: 'auItemButtonClassName' });
        /**
         * CSS classes to add on the accordion-item body container DOM element.
         * The accordion-item body container is the DOM element on what the itemTransition is applied.
         *
         * @defaultValue \`''\`
         */
        this.itemBodyContainerClassName = input(undefined, { ...(ngDevMode ? { debugName: "itemBodyContainerClassName" } : /* istanbul ignore next */ {}), alias: 'auItemBodyContainerClassName' });
        /**
         * CSS classes to add on the accordion-item body DOM element.
         *
         * @defaultValue \`''\`
         */
        this.itemBodyClassName = input(undefined, { ...(ngDevMode ? { debugName: "itemBodyClassName" } : /* istanbul ignore next */ {}), alias: 'auItemBodyClassName' });
        /**
         * The html heading level to use for the accordion-item-header.
         *
         * @defaultValue \`2\`
         */
        this.itemHeadingLevel = input(undefined, { ...(ngDevMode ? { debugName: "itemHeadingLevel" } : /* istanbul ignore next */ {}), alias: 'auItemHeadingLevel' });
    }
...
function SliderDefaultHandleSlotComponent_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵproperty("auUse", i0.ɵɵpureFunction2(3, _c2$5, directives_r3.handleDirective, i0.ɵɵpureFunction1(1, _c1$5, item_r4)));
} }
const _c3$5 = ["tick"];
...
function SliderDefaultTickSlotComponent_ng_template_0_Conditional_0_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵproperty("auUse", i0.ɵɵpureFunction2(4, _c2$5, directives_r2.tickLabelDirective, i0.ɵɵpureFunction1(2, _c4$4, tick_r3)));
    i0.ɵɵadvance();
...
function SliderDefaultTickSlotComponent_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance();
    i0.ɵɵproperty("auUse", i0.ɵɵpureFunction2(9, _c2$5, directives_r2.tickDirective, i0.ɵɵpureFunction1(7, _c4$4, tick_r3)));
    i0.ɵɵadvance(2);
...
function SliderDefaultStructureSlotComponent_ng_template_0_For_6_Template(rf, ctx) { if (rf & 1) {
    ...
    const directives_r2 = ctx_r2.directives;
    const api_r5 = ctx_r2.api;
    i0.ɵɵproperty("auSlot", state_r4.tick())("auSlotProps", i0.ɵɵpureFunction4(2, _c8, state_r4, api_r5, directives_r2, tick_r6));
} }
...
const _c11 = (a0, a1, a2) => ({ state: a0, api: a1, directives: a2 });
...
class SliderDefaultHandleSlotComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: SliderDefaultHandleSlotComponent, selectors: [["ng-component"]], viewQuery: function SliderDefaultHandleSlotComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [UseDirective, SliderHandleDirective], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(SliderDefaultHandleSlotComponent, { className: "SliderDefaultHandleSlotComponent", filePath: "components/slider/slider.component.ts", lineNumber: 62 }); })();
/**
...
class SliderDefaultTickSlotComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: SliderDefaultTickSlotComponent, selectors: [["ng-component"]], viewQuery: function SliderDefaultTickSlotComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [UseDirective, SliderTickDirective], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(SliderDefaultTickSlotComponent, { className: "SliderDefaultTickSlotComponent", filePath: "components/slider/slider.component.ts", lineNumber: 133 }); })();
/**
...
class SliderDefaultStructureSlotComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: SliderDefaultStructureSlotComponent, selectors: [["ng-component"]], viewQuery: function SliderDefaultStructureSlotComponent_Query(rf, ctx) { if (rf & 1) {
            i0.ɵɵviewQuerySignal(ctx.structure, _c5$1, 5);
        } if (rf & 2) {
            i0.ɵɵqueryAdvance();
        ...
        } }, dependencies: [SlotDirective, SliderStructureDirective, UseDirective], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(SliderDefaultStructureSlotComponent, { className: "SliderDefaultStructureSlotComponent", filePath: "components/slider/slider.component.ts", lineNumber: 196 }); })();
/**
...
class SliderComponent extends BaseWidgetDirective {
    constructor() {
         ...
         * @defaultValue \`0\`
         */
        this.min = input(undefined, { ...(ngDevMode ? { debugName: "min" } : /* istanbul ignore next */ {}), alias: 'auMin', transform: auNumberAttribute });
        /**
         * Maximum value that can be assigned to the slider
         *
         * @defaultValue \`100\`
         */
        this.max = input(undefined, { ...(ngDevMode ? { debugName: "max" } : /* istanbul ignore next */ {}), alias: 'auMax', transform: auNumberAttribute });
        /**
         ...
         * @defaultValue \`0\`
         */
        this.minRange = input(undefined, { ...(ngDevMode ? { debugName: "minRange" } : /* istanbul ignore next */ {}), alias: 'auMinRange', transform: auNumberAttribute });
        /**
         ...
         * @defaultValue \`0\`
         */
        this.maxRange = input(undefined, { ...(ngDevMode ? { debugName: "maxRange" } : /* istanbul ignore next */ {}), alias: 'auMaxRange', transform: auNumberAttribute });
        /**
         ...
         * @defaultValue \`false\`
         */
        this.pushRange = input(undefined, { ...(ngDevMode ? { debugName: "pushRange" } : /* istanbul ignore next */ {}), alias: 'auPushRange', transform: auBooleanAttribute });
        /**
         * Unit value between slider steps
         *
         * @defaultValue \`1\`
         */
        this.stepSize = input(undefined, { ...(ngDevMode ? { debugName: "stepSize" } : /* istanbul ignore next */ {}), alias: 'auStepSize', transform: auNumberAttribute });
        /**
         * Current slider values
         *
         * @defaultValue \`[0]\`
         */
        this.values = input(undefined, { ...(ngDevMode ? { debugName: "values" } : /* istanbul ignore next */ {}), alias: 'auValues' });
        /**
         * It \`true\` slider display is inversed
         *
         * @defaultValue \`false\`
         */
        this.rtl = input(undefined, { ...(ngDevMode ? { debugName: "rtl" } : /* istanbul ignore next */ {}), alias: 'auRtl', transform: auBooleanAttribute });
        /**
         * If \`true\` the value labels are displayed on the slider
         *
         * @defaultValue \`true\`
         */
        this.showValueLabels = input(undefined, { ...(ngDevMode ? { debugName: "showValueLabels" } : /* istanbul ignore next */ {}), alias: 'auShowValueLabels', transform: auBooleanAttribute });
        /**
         * If \`true\` the min and max labels are displayed on the slider
         *
         * @defaultValue \`true\`
         */
        this.showMinMaxLabels = input(undefined, { ...(ngDevMode ? { debugName: "showMinMaxLabels" } : /* istanbul ignore next */ {}), alias: 'auShowMinMaxLabels', transform: auBooleanAttribute });
        /**
         ...
         * \`\`\`
         */
        this.ariaValueText = input(undefined, { ...(ngDevMode ? { debugName: "ariaValueText" } : /* istanbul ignore next */ {}), alias: 'auAriaValueText' });
        /**
         ...
         * @defaultValue \`false\`
         */
        this.vertical = input(undefined, { ...(ngDevMode ? { debugName: "vertical" } : /* istanbul ignore next */ {}), alias: 'auVertical', transform: auBooleanAttribute });
        /**
         * If \`true\` the ticks are displayed on the slider
         *
         * @defaultValue \`false\`
         */
        this.showTicks = input(undefined, { ...(ngDevMode ? { debugName: "showTicks" } : /* istanbul ignore next */ {}), alias: 'auShowTicks', transform: auBooleanAttribute });
        /**
         ...
         * @defaultValue \`0\`
         */
        this.tickInterval = input(undefined, { ...(ngDevMode ? { debugName: "tickInterval" } : /* istanbul ignore next */ {}), alias: 'auTickInterval', transform: auNumberAttribute });
        /**
         * If \`true\` the tick values are displayed on the slider
         *
         * @defaultValue \`true\`
         */
        this.showTickValues = input(undefined, { ...(ngDevMode ? { debugName: "showTickValues" } : /* istanbul ignore next */ {}), alias: 'auShowTickValues', transform: auBooleanAttribute });
        /**
         ...
         * \`\`\`
         */
        this.label = input(undefined, { ...(ngDevMode ? { debugName: "label" } : /* istanbul ignore next */ {}), alias: 'auLabel' });
        this.slotLabelFromContent = contentChild(SliderLabelDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotLabelFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Slot to change the default display of the slider
         */
        this.structure = input(undefined, { ...(ngDevMode ? { debugName: "structure" } : /* istanbul ignore next */ {}), alias: 'auStructure' });
        this.slotStructureFromContent = contentChild(SliderStructureDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Slot to change the handlers
         */
        this.handle = input(undefined, { ...(ngDevMode ? { debugName: "handle" } : /* istanbul ignore next */ {}), alias: 'auHandle' });
        this.slotHandleFromContent = contentChild(SliderHandleDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotHandleFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Slot to change the ticks
         */
        this.tick = input(undefined, { ...(ngDevMode ? { debugName: "tick" } : /* istanbul ignore next */ {}), alias: 'auTick' });
        this.slotTickFromContent = contentChild(SliderTickDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotTickFromContent" }] : /* istanbul ignore next */ []));
        /**
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: SliderComponent, selectors: [["", "auSlider", ""]], contentQueries: function SliderComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
            ...
            i0.ɵɵadvance();
            i0.ɵɵproperty("auSlot", ctx.state.structure())("auSlotProps", i0.ɵɵpureFunction3(3, _c11, ctx.state, ctx.api, ctx.directives));
        } }, dependencies: [SlotDirective, UseDirective], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(SliderComponent, { className: "SliderComponent", filePath: "components/slider/slider.component.ts", lineNumber: 224 }); })();
...
class ProgressbarDefaultSlotsComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ProgressbarDefaultSlotsComponent, selectors: [["ng-component"]], viewQuery: function ProgressbarDefaultSlotsComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [NgClass, SlotDirective, ProgressbarStructureDirective], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(ProgressbarDefaultSlotsComponent, { className: "ProgressbarDefaultSlotsComponent", filePath: "components/progressbar/progressbar.component.ts", lineNumber: 61 }); })();
/**
...
class ProgressbarComponent extends BaseWidgetDirective {
    constructor() {
         ...
         * @defaultValue \`0\`
         */
        this.value = input(undefined, { ...(ngDevMode ? { debugName: "value" } : /* istanbul ignore next */ {}), alias: 'auValue', transform: auNumberAttribute });
        /**
         * CSS classes to be applied on the widget main container
         *
         * @defaultValue \`''\`
         ...
         */
        this.children = input(undefined, { ...(ngDevMode ? { debugName: "children" } : /* istanbul ignore next */ {}), alias: 'auChildren' });
        this.slotDefaultFromContent = contentChild(ProgressbarBodyDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotDefaultFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Global template for the Progressbar.
         */
        this.structure = input(undefined, { ...(ngDevMode ? { debugName: "structure" } : /* istanbul ignore next */ {}), alias: 'auStructure' });
        this.slotStructureFromContent = contentChild(ProgressbarStructureDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        /**
         ...
         * @defaultValue \`''\`
         */
        this.height = input(undefined, { ...(ngDevMode ? { debugName: "height" } : /* istanbul ignore next */ {}), alias: 'auHeight' });
        /**
         ...
         * @defaultValue \`false\`
         */
        this.striped = input(undefined, { ...(ngDevMode ? { debugName: "striped" } : /* istanbul ignore next */ {}), alias: 'auStriped', transform: auBooleanAttribute });
        /**
         * Return the value for the 'aria-valuetext' attribute.
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(ProgressbarComponent, { className: "ProgressbarComponent", filePath: "components/progressbar/progressbar.component.ts", lineNumber: 87 }); })();
...
function ToastComponent_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵproperty("auUseMulti", i0.ɵɵpureFunction3(7, _c4$3, ctx_r0.directives.autoHideDirective, ctx_r0.directives.transitionDirective, ctx_r0.directives.bodyDirective));
    i0.ɵɵadvance();
...
class ToastDefaultSlotsComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ToastDefaultSlotsComponent, selectors: [["ng-component"]], viewQuery: function ToastDefaultSlotsComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [SlotDirective, ToastStructureDirective, UseDirective], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(ToastDefaultSlotsComponent, { className: "ToastDefaultSlotsComponent", filePath: "components/toast/toast.component.ts", lineNumber: 71 }); })();
/**
...
class ToastComponent extends BaseWidgetDirective {
    constructor() {
         ...
         * @defaultValue \`true\`
         */
        this.autoHide = input(undefined, { ...(ngDevMode ? { debugName: "autoHide" } : /* istanbul ignore next */ {}), alias: 'auAutoHide', transform: auBooleanAttribute });
        /**
         * Delay in milliseconds before hiding the toast.
         *
         * @defaultValue \`5000\`
         */
        this.delay = input(undefined, { ...(ngDevMode ? { debugName: "delay" } : /* istanbul ignore next */ {}), alias: 'auDelay', transform: auNumberAttribute });
        /**
         * Accessibility close button label
         *
         * @defaultValue \`'Close'\`
         ...
         */
        this.children = input(undefined, { ...(ngDevMode ? { debugName: "children" } : /* istanbul ignore next */ {}), alias: 'auChildren' });
        this.slotDefaultFromContent = contentChild(ToastBodyDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotDefaultFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Global template for the toast component
         */
        this.structure = input(undefined, { ...(ngDevMode ? { debugName: "structure" } : /* istanbul ignore next */ {}), alias: 'auStructure' });
        this.slotStructureFromContent = contentChild(ToastStructureDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Header template for the toast component
         */
        this.header = input(undefined, { ...(ngDevMode ? { debugName: "header" } : /* istanbul ignore next */ {}), alias: 'auHeader' });
        this.slotHeaderFromContent = contentChild(ToastHeaderDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotHeaderFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Callback called when the alert visibility changed.
         *
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ToastComponent, selectors: [["", "auToast", ""]], contentQueries: function ToastComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
            ...
            i0.ɵɵqueryAdvance();
        } }, inputs: { dismissible: [1, "auDismissible", "dismissible"], transition: [1, "auTransition", "transition"], visible: [1, "auVisible", "visible"], animatedOnInit: [1, "auAnimatedOnInit", "animatedOnInit"], animated: [1, "auAnimated", "animated"], autoHide: [1, "auAutoHide", "autoHide"], delay: [1, "auDelay", "delay"], ariaCloseButtonLabel: [1, "auAriaCloseButtonLabel", "ariaCloseButtonLabel"], children: [1, "auChildren", "children"], structure: [1, "auStructure", "structure"], header: [1, "auHeader", "header"], className: [1, "auClassName", "className"] }, outputs: { visibleChange: "auVisibleChange", hidden: "auHidden", shown: "auShown" }, features: [i0.ɵɵInheritDefinitionFeature], ngContentSelectors: _c3$3, decls: 3, vars: 1, consts: [["content", ""], [3, "d-flex", "toast-dismissible", "auUseMulti"], [3, "auUseMulti"], [3, "auSlot", "auSlotProps"]], template: function ToastComponent_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵprojectionDef();
            ...
            i0.ɵɵadvance(2);
            i0.ɵɵconditional(!ctx.state.hidden() ? 2 : -1);
        } }, dependencies: [SlotDirective, UseMultiDirective], encapsulation: 2 }); }
}
...
class CollapseDirective extends BaseWidgetDirective {
    constructor() {
         ...
         * @defaultValue \`false\`
         */
        this.horizontal = input(undefined, { ...(ngDevMode ? { debugName: "horizontal" } : /* istanbul ignore next */ {}), alias: 'auHorizontal', transform: auBooleanAttribute });
        /**
...
class CollapseTriggerDirective {
    constructor() {
        this.auCollapseTrigger = input.required(/* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "auCollapseTrigger" }] : /* istanbul ignore next */ []));
...
const _c7 = (a0, a1, a2) => ({ state: a0, api: a1, directives: a2 });
...
class TreeDefaultStructureSlotComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TreeDefaultStructureSlotComponent, selectors: [["ng-component"]], viewQuery: function TreeDefaultStructureSlotComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [UseDirective, TreeStructureDirective, SlotDirective], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(TreeDefaultStructureSlotComponent, { className: "TreeDefaultStructureSlotComponent", filePath: "components/tree/tree.component.ts", lineNumber: 32 }); })();
/**
...
class TreeDefaultItemToggleSlotComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TreeDefaultItemToggleSlotComponent, selectors: [["ng-component"]], viewQuery: function TreeDefaultItemToggleSlotComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [UseDirective, TreeItemToggleDirective], encapsulation: 2 }); }
}
...
class TreeDefaultItemContentSlotComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TreeDefaultItemContentSlotComponent, selectors: [["ng-component"]], viewQuery: function TreeDefaultItemContentSlotComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [SlotDirective, TreeItemContentDirective], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(TreeDefaultItemContentSlotComponent, { className: "TreeDefaultItemContentSlotComponent", filePath: "components/tree/tree.component.ts", lineNumber: 107 }); })();
/**
...
class TreeDefaultItemSlotComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TreeDefaultItemSlotComponent, selectors: [["ng-component"]], viewQuery: function TreeDefaultItemSlotComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [UseDirective, SlotDirective, TreeItemDirective], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(TreeDefaultItemSlotComponent, { className: "TreeDefaultItemSlotComponent", filePath: "components/tree/tree.component.ts", lineNumber: 149 }); })();
/**
 * A constant representing the default slot for tree item.
 */
...
class TreeComponent extends BaseWidgetDirective {
    constructor() {
         ...
         * @defaultValue \`[]\`
         */
        this.nodes = input(undefined, { ...(ngDevMode ? { debugName: "nodes" } : /* istanbul ignore next */ {}), alias: 'auNodes' });
        /**
         * CSS classes to be applied on the widget main container
         *
         * @defaultValue \`''\`
         ...
         * \`\`\`
         */
        this.navSelector = input(undefined, { ...(ngDevMode ? { debugName: "navSelector" } : /* istanbul ignore next */ {}), alias: 'auNavSelector' });
        /**
         ...
         * \`\`\`
         */
        this.ariaLabelToggleFn = input(undefined, { ...(ngDevMode ? { debugName: "ariaLabelToggleFn" } : /* istanbul ignore next */ {}), alias: 'auAriaLabelToggleFn' });
        /**
         ...
         */
        this.itemContent = input(undefined, { ...(ngDevMode ? { debugName: "itemContent" } : /* istanbul ignore next */ {}), alias: 'auItemContent' });
        this.slotItemContentFromContent = contentChild(TreeItemContentDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotItemContentFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Slot to change the default display of the tree
         */
        this.structure = input(undefined, { ...(ngDevMode ? { debugName: "structure" } : /* istanbul ignore next */ {}), alias: 'auStructure' });
        this.slotStructureFromContent = contentChild(TreeStructureDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Slot to change the default tree item toggle
         */
        this.itemToggle = input(undefined, { ...(ngDevMode ? { debugName: "itemToggle" } : /* istanbul ignore next */ {}), alias: 'auItemToggle' });
        this.slotItemToggleFromContent = contentChild(TreeItemToggleDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotItemToggleFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Slot to change the default tree item
         */
        this.item = input(undefined, { ...(ngDevMode ? { debugName: "item" } : /* istanbul ignore next */ {}), alias: 'auItem' });
        this.slotItemFromContent = contentChild(TreeItemDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotItemFromContent" }] : /* istanbul ignore next */ []));
    }
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(TreeComponent, { className: "TreeComponent", filePath: "components/tree/tree.component.ts", lineNumber: 173 }); })();
...
class CarouselDefaultSlotsComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: CarouselDefaultSlotsComponent, selectors: [["ng-component"]], viewQuery: function CarouselDefaultSlotsComponent_Query(rf, ctx) { if (rf & 1) {
            i0.ɵɵviewQuerySignal(ctx.structure, _c0$2, 5)(ctx.navigation, _c1$1, 5);
        } if (rf & 2) {
            i0.ɵɵqueryAdvance(2);
        ...
        } }, dependencies: [SlotDirective, CarouselStructureDirective, CarouselNavigationDirective, UseDirective], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(CarouselDefaultSlotsComponent, { className: "CarouselDefaultSlotsComponent", filePath: "components/carousel/carousel.component.ts", lineNumber: 106 }); })();
/**
 * The default slot for the structure
 */
...
class CarouselComponent extends BaseWidgetDirective {
    constructor() {
         ...
         * \`\`\`
         */
        this.ariaIndicatorLabel = input(undefined, { ...(ngDevMode ? { debugName: "ariaIndicatorLabel" } : /* istanbul ignore next */ {}), alias: 'auAriaIndicatorLabel' });
        /**
         * Aria label for previous button
         *
         * @defaultValue \`'Select previous slide'\`
         */
        this.ariaPrevLabel = input(undefined, { ...(ngDevMode ? { debugName: "ariaPrevLabel" } : /* istanbul ignore next */ {}), alias: 'auAriaPrevLabel' });
        /**
         ...
         * @defaultValue \`'ltr'\`
         */
        this.direction = input(undefined, { ...(ngDevMode ? { debugName: "direction" } : /* istanbul ignore next */ {}), alias: 'auDirection' });
        /**
         ...
         * @defaultValue \`false\`
         */
        this.dragFree = input(undefined, { ...(ngDevMode ? { debugName: "dragFree" } : /* istanbul ignore next */ {}), alias: 'auDragFree', transform: auBooleanAttribute });
        /**
         ...
         * @defaultValue \`10\`
         */
        this.dragThreshold = input(undefined, { ...(ngDevMode ? { debugName: "dragThreshold" } : /* istanbul ignore next */ {}), alias: 'auDragThreshold', transform: auNumberAttribute });
        /**
         ...
         * @defaultValue \`25\`
         */
        this.duration = input(undefined, { ...(ngDevMode ? { debugName: "duration" } : /* istanbul ignore next */ {}), alias: 'auDuration', transform: auNumberAttribute });
        /**
         ...
         * @defaultValue \`false\`
         */
        this.loop = input(undefined, { ...(ngDevMode ? { debugName: "loop" } : /* istanbul ignore next */ {}), alias: 'auLoop', transform: auBooleanAttribute });
        /**
         ...
         * @defaultValue \`false\`
         */
        this.skipSnaps = input(undefined, { ...(ngDevMode ? { debugName: "skipSnaps" } : /* istanbul ignore next */ {}), alias: 'auSkipSnaps', transform: auBooleanAttribute });
        /**
         * If \`true\`, 'previous' and 'next' navigation arrows will be visible.
         *
         * @defaultValue \`true\`
         */
        this.showNavigationArrows = input(undefined, { ...(ngDevMode ? { debugName: "showNavigationArrows" } : /* istanbul ignore next */ {}), alias: 'auShowNavigationArrows', transform: auBooleanAttribute });
        /**
         * If \`true\`, navigation indicators at the bottom of the slide will be visible.
         *
         * @defaultValue \`true\`
         */
        this.showNavigationIndicators = input(undefined, { ...(ngDevMode ? { debugName: "showNavigationIndicators" } : /* istanbul ignore next */ {}), alias: 'auShowNavigationIndicators', transform: auBooleanAttribute });
        /**
         * Plugins to extend the carousel with additional features
         * @defaultValue \`[]\`
         */
        this.plugins = input(undefined, { ...(ngDevMode ? { debugName: "plugins" } : /* istanbul ignore next */ {}), alias: 'auPlugins' });
        /**
         ...
         * @defaultValue \`'center'\`
         */
        this.align = input(undefined, { ...(ngDevMode ? { debugName: "align" } : /* istanbul ignore next */ {}), alias: 'auAlign' });
        /**
         ...
         */
        this.containScroll = input(undefined, { ...(ngDevMode ? { debugName: "containScroll" } : /* istanbul ignore next */ {}), alias: 'auContainScroll' });
        /**
         * CSS classes to be applied on the widget main container
         *
         * @defaultValue \`''\`
         ...
         * @defaultValue \`''\`
         */
        this.containerClass = input(undefined, { ...(ngDevMode ? { debugName: "containerClass" } : /* istanbul ignore next */ {}), alias: 'auContainerClass' });
        /**
         * Class name to apply to each slide in the carousel.
         *
         * @defaultValue \`''\`
         */
        this.slideClass = input(undefined, { ...(ngDevMode ? { debugName: "slideClass" } : /* istanbul ignore next */ {}), alias: 'auSlideClass' });
        /**
         * The aria-live attribute value for the carousel container.
         *
         * @defaultValue \`'polite'\`
         */
        this.ariaLive = input(undefined, { ...(ngDevMode ? { debugName: "ariaLive" } : /* istanbul ignore next */ {}), alias: 'auAriaLive' });
        /**
         * The data for each slide in the carousel.
         *
         * @defaultValue \`[]\`
         */
        this.slidesData = input(undefined, { ...(ngDevMode ? { debugName: "slidesData" } : /* istanbul ignore next */ {}), alias: 'auSlidesData' });
        /**
         ...
         */
        this.navigation = input(undefined, { ...(ngDevMode ? { debugName: "navigation" } : /* istanbul ignore next */ {}), alias: 'auNavigation' });
        /**
         * The content of each slide in the carousel.
         */
        this.slide = input(undefined, { ...(ngDevMode ? { debugName: "slide" } : /* istanbul ignore next */ {}), alias: 'auSlide' });
        this.slotSlideFromContent = contentChild((CarouselSlideDirective), /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotSlideFromContent" }] : /* istanbul ignore next */ []));
        this.slotStructureFromContent = contentChild((CarouselStructureDirective), /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        this.slotNavigationFromContent = contentChild((CarouselNavigationDirective), /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotNavigationFromContent" }] : /* istanbul ignore next */ []));
    }
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(CarouselComponent, { className: "CarouselComponent", filePath: "components/carousel/carousel.component.ts", lineNumber: 136 }); })();
...
class ToasterService extends ToasterService$1 {
    ...
    static { this.ɵprov = /*@__PURE__*/ i0.ɵɵdefineService({ token: ToasterService, factory: ToasterService.ɵfac }); }
}
...
function ToasterComponent_For_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵproperty("auUse", i0.ɵɵpureFunction2(9, _c0$1, ctx_r1.toasterService.eventsDirective, toast_r4.id));
    i0.ɵɵadvance();
...
class ToasterComponent {
    constructor() {
        ...
        this.auDismissible = input(this.toasterService.options().dismissible, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "auDismissible" }] : /* istanbul ignore next */ []));
        this.auDuration = input(this.toasterService.options().duration, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "auDuration" }] : /* istanbul ignore next */ []));
        this.auPosition = input(this.toasterService.options().position, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "auPosition" }] : /* istanbul ignore next */ []));
        this.auLimit = input(this.toasterService.options().limit, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "auLimit" }] : /* istanbul ignore next */ []));
        this.auPauseOnHover = input(this.toasterService.options().pauseOnHover, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "auPauseOnHover" }] : /* istanbul ignore next */ []));
        this.auCloseAll = input(this.toasterService.options().closeAll, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "auCloseAll" }] : /* istanbul ignore next */ []));
        this.auCloseAllLabel = input(this.toasterService.options().closeAllLabel, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "auCloseAllLabel" }] : /* istanbul ignore next */ []));
        this.positionClass = computed(() => export_toastPositions[this.toasterService.options().position], /* @ts-ignore */
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ToasterComponent, selectors: [["", "auToaster", ""]], hostAttrs: ["aria-live", "polite", "aria-atomic", "true", 1, "au-toaster"], inputs: { auDismissible: [1, "auDismissible"], auDuration: [1, "auDuration"], auPosition: [1, "auPosition"], auLimit: [1, "auLimit"], auPauseOnHover: [1, "auPauseOnHover"], auCloseAll: [1, "auCloseAll"], auCloseAllLabel: [1, "auCloseAllLabel"] }, decls: 4, vars: 3, consts: [[1, "d-flex", "position-relative", "align-items-end", "pb-2"], [3, "auUse"], [1, "au-toaster-closeAll", "btn", "btn-secondary", "me-0", "ms-auto", "pe-auto", 3, "click"], ["auToast", "", 3, "auHidden", "auVisibleChange", "auDismissible", "auAnimated", "auAutoHide", "auClassName", "auAriaCloseButtonLabel", "auStructure", "auChildren", "auHeader"]], template: function ToasterComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [UseDirective, ToastComponent], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(ToasterComponent, { className: "ToasterComponent", filePath: "components/toast/toaster.component.ts", lineNumber: 44 }); })();
...
function DrawerComponent_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r0 = i0.ɵɵnextContext();
    i0.ɵɵproperty("auUseMulti", i0.ɵɵpureFunction2(5, _c4, ctx_r0.directives.drawerPortalDirective, ctx_r0.directives.drawerDirective));
    i0.ɵɵadvance();
...
function DrawerComponent_Conditional_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r0 = i0.ɵɵnextContext();
    i0.ɵɵproperty("auUseMulti", i0.ɵɵpureFunction2(1, _c4, ctx_r0.directives.backdropPortalDirective, ctx_r0.directives.backdropDirective));
} }
/**
...
class DrawerDefaultSlotsComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: DrawerDefaultSlotsComponent, selectors: [["ng-component"]], viewQuery: function DrawerDefaultSlotsComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [SlotDirective, DrawerStructureDirective], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(DrawerDefaultSlotsComponent, { className: "DrawerDefaultSlotsComponent", filePath: "components/drawer/drawer.component.ts", lineNumber: 67 }); })();
/**
...
class DrawerComponent extends BaseWidgetDirective {
    constructor() {
         ...
         * @defaultValue \`''\`
         */
        this.ariaDescribedBy = input(undefined, { ...(ngDevMode ? { debugName: "ariaDescribedBy" } : /* istanbul ignore next */ {}), alias: 'auAriaDescribedBy' });
        /**
         ...
         * \`\`\`
         */
        this.verticalTransition = input(undefined, { ...(ngDevMode ? { debugName: "verticalTransition" } : /* istanbul ignore next */ {}), alias: 'auVerticalTransition' });
        /**
         ...
         * @defaultValue \`false\`
         */
        this.bodyScroll = input(undefined, { ...(ngDevMode ? { debugName: "bodyScroll" } : /* istanbul ignore next */ {}), alias: 'auBodyScroll', transform: auBooleanAttribute });
        /**
         ...
         * @defaultValue \`null\`
         */
        this.size = input(undefined, { ...(ngDevMode ? { debugName: "size" } : /* istanbul ignore next */ {}), alias: 'auSize', transform: auNumberOrNullAttribute });
        /**
         * If \`true\` focuses the drawer when it is opened.
         *
         * @defaultValue \`true\`
         */
        this.focusOnInit = input(undefined, { ...(ngDevMode ? { debugName: "focusOnInit" } : /* istanbul ignore next */ {}), alias: 'auFocusOnInit', transform: auBooleanAttribute });
        /**
         * Classes to add on the backdrop DOM element.
         *
         * @defaultValue \`''\`
         ...
         * @defaultValue \`false\`
         */
        this.resizable = input(undefined, { ...(ngDevMode ? { debugName: "resizable" } : /* istanbul ignore next */ {}), alias: 'auResizable', transform: auBooleanAttribute });
        /**
         ...
         */
        this.structure = input(undefined, { ...(ngDevMode ? { debugName: "structure" } : /* istanbul ignore next */ {}), alias: 'auStructure' });
        this.slotStructureFromContent = contentChild(DrawerStructureDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Template for the drawer header
         */
        this.header = input(undefined, { ...(ngDevMode ? { debugName: "header" } : /* istanbul ignore next */ {}), alias: 'auHeader' });
        this.slotHeaderFromContent = contentChild(DrawerHeaderDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotHeaderFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Template for the drawer body
         */
        this.children = input(undefined, { ...(ngDevMode ? { debugName: "children" } : /* istanbul ignore next */ {}), alias: 'auChildren' });
        this.slotBodyFromContent = contentChild(DrawerBodyDirective, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotBodyFromContent" }] : /* istanbul ignore next */ []));
        this.slotChildren = viewChild('content', /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotChildren" }] : /* istanbul ignore next */ []));
    }
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: DrawerComponent, selectors: [["", "auDrawer", ""]], contentQueries: function DrawerComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        } }, dependencies: [UseMultiDirective, SlotDirective, UseDirective], encapsulation: 2 }); }
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(DrawerComponent, { className: "DrawerComponent", filePath: "components/drawer/drawer.component.ts", lineNumber: 102 }); })();
...
class ModalService {
    ...
    static { this.ɵprov = /*@__PURE__*/ i0.ɵɵdefineService({ token: ModalService, factory: ModalService.ɵfac }); }
}
