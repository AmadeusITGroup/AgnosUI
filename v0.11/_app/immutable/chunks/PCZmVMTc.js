const o=`import type { ToasterProps, ToastProps } from './toast.gen';
 ...
 */
export declare function ToasterContainer(): import("react").JSX.Element;
/**
...
export declare const useToaster: () => {
    toasts: import("@agnos-ui/core/components/toast").ToasterToast<Partial<ToastProps>>[];
    options: import("@agnos-ui/core/components/toast").ToasterProps;
