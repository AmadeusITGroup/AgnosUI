...
import { inject, NgZone, Service, signal, DestroyRef, Injector, runInInjectionContext, Directive, ElementRef, PLATFORM_ID, afterNextRender, input, computed as computed$1, InjectionToken, SkipSelf, Optional, booleanAttribute, numberAttribute, viewChild, Component, createComponent, EnvironmentInjector, TemplateRef, reflectComponentType, ViewContainerRef } from '@angular/core';
...
class ZoneWrapper {
    ...
    static { this.ɵprov = /*@__PURE__*/ i0.ɵɵdefineService({ token: ZoneWrapper, factory: ZoneWrapper.ɵfac }); }
}
...
class UseDirective {
    constructor() {
        this.use = input.required({ ...(ngDevMode ? { debugName: "use" } : /* istanbul ignore next */ {}), alias: 'auUse' });
...
class UseMultiDirective {
    constructor() {
         ...
         */
        this.useMulti = input.required({ ...(ngDevMode ? { debugName: "useMulti" } : /* istanbul ignore next */ {}), alias: 'auUseMulti' });
        this.#useDirective = useDirectiveForHost();
    }
    #useDirective;
    /** @internal */
...
class SlotComponent {
    constructor() {
         ...
         */
        this.state = input.required(/* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "state" }] : /* istanbul ignore next */ []));
        /**
         * all the api functions to interact with the widget
         */
        this.api = input.required(/* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "api" }] : /* istanbul ignore next */ []));
        /**
         * directives to be used on html elements in the template of the slot
         */
        this.directives = input.required(/* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "directives" }] : /* istanbul ignore next */ []));
        /**
         * The slot context, to be used when the slot component uses other slots.
         */
        this.slotContext = computed$1(() => ({ state: this.state(), api: this.api(), directives: this.directives() }), /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "slotContext" }] : /* istanbul ignore next */ []));
    }
...
class SlotDirective {
    constructor() {
         ...
         */
        this.slot = input.required({ ...(ngDevMode ? { debugName: "slot" } : /* istanbul ignore next */ {}), alias: 'auSlot' });
        /**
         * The properties for the slot content.
         */
        this.props = input.required({ ...(ngDevMode ? { debugName: "props" } : /* istanbul ignore next */ {}), alias: 'auSlotProps' });
