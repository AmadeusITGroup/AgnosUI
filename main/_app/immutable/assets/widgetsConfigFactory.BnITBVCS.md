...
> **useWidgetWithConfig**: \<`W`\>(`factory`, `props`, `widgetName`, `defaultProps`?) => [[`WidgetState`](../type-aliases/WidgetState.md)\<`W`\>, `W`]
...
[[`WidgetState`](../type-aliases/WidgetState.md)\<`W`\>, `W`]
...
[react/headless/src/config.tsx:24](https://github.com/AmadeusITGroup/AgnosUI/blob/7bbce80d746002b4e4948e5d87a1cb294a9d18ca/react/headless/src/config.tsx#L24)
