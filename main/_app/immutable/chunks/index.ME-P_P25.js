...
const pagination = require("./pagination-ZiEI1UYE.cjs");
const progressbar = require("./progressbar-BO7zD538.cjs");
const rating = require("./rating-DRfb2bEA.cjs");
const select = require("./select-LBVhNdrd.cjs");
const slider = require("./slider-B7UjGzhV.cjs");
