...
function CarouselDefaultSlotsComponent_ng_template_0_Conditional_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵrepeaterCreate(1, CarouselDefaultSlotsComponent_ng_template_0_Conditional_1_For_2_Template, 1, 7, "button", 4, _forTrack0$1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r4 = i0.ɵɵnextContext();
    const state_r2 = ctx_r4.state;
    const directives_r1 = ctx_r4.directives;
    i0.ɵɵproperty("auUse", directives_r1.tabList);
    i0.ɵɵadvance();
...
function CarouselDefaultSlotsComponent_ng_template_2_For_3_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 4);
    i0.ɵɵtemplate(1, CarouselDefaultSlotsComponent_ng_template_2_For_3_ng_template_1_Template, 0, 0, "ng-template", 9);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const slideData_r6 = ctx.$implicit;
    const ɵ$index_26_r7 = ctx.$index;
    const ctx_r7 = i0.ɵɵnextContext();
    const state_r9 = ctx_r7.state;
    const api_r10 = ctx_r7.api;
    const directives_r11 = ctx_r7.directives;
    const ctx_r11 = i0.ɵɵnextContext();
    i0.ɵɵproperty("auUse", i0.ɵɵpureFunction2(6, _c3, directives_r11.slide, i0.ɵɵpureFunction2(3, _c2, ɵ$index_26_r7, slideData_r6.id)));
    i0.ɵɵadvance();
    i0.ɵɵproperty("auSlot", state_r9.slide())("auSlotProps", ctx_r11.toSlideContext(slideData_r6, i0.ɵɵpureFunction3(9, _c4, state_r9, api_r10, directives_r11)));
} }
function CarouselDefaultSlotsComponent_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵtemplate(0, CarouselDefaultSlotsComponent_ng_template_2_ng_template_0_Template, 0, 0, "ng-template", 9);
    i0.ɵɵelementStart(1, "div", 10);
    i0.ɵɵrepeaterCreate(2, CarouselDefaultSlotsComponent_ng_template_2_For_3_Template, 2, 13, "div", 4, _forTrack0$1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const state_r9 = ctx.state;
    const api_r10 = ctx.api;
    const directives_r11 = ctx.directives;
    i0.ɵɵproperty("auSlot", state_r9.navigation())("auSlotProps", i0.ɵɵpureFunction3(2, _c4, state_r9, api_r10, directives_r11));
    i0.ɵɵadvance(2);
    i0.ɵɵrepeater(state_r9.slidesData());
} }
...
class CarouselDefaultSlotsComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: CarouselDefaultSlotsComponent, selectors: [["ng-component"]], viewQuery: function CarouselDefaultSlotsComponent_Query(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵqueryAdvance(2);
        } }, decls: 4, vars: 0, consts: [["navigation", ""], ["structure", ""], ["auCarouselNavigation", ""], ["auCarouselStructure", ""], [3, "auUse"], [1, "carousel-control-prev", 3, "auUse"], [1, "carousel-control-next", 3, "auUse"], [1, "carousel-control-prev-icon"], [1, "carousel-control-next-icon"], [3, "auSlot", "auSlotProps"], ["aria-atomic", "false", "aria-live", "polite", 1, "au-carousel-container"]], template: function CarouselDefaultSlotsComponent_Template(rf, ctx) { if (rf & 1) {
