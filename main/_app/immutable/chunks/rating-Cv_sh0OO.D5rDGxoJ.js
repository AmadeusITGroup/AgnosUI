...
function Rating(props) {
  const [state, widget] = generated_config.useWidgetWithConfig(rating.createRating, props, "rating");
  const {
    directives: { containerDirective, starDirective }
  } = widget;
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "d-inline-flex", ...directive.useDirective(containerDirective), children: state.stars.map((star) => /* @__PURE__ */ jsxRuntime.jsx(Star, { star, state, directive: starDirective }, star.index)) });
}
