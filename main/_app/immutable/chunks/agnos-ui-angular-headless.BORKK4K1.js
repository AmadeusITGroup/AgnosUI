...
import { inject, NgZone, Injectable, signal, DestroyRef, Injector, ElementRef, PLATFORM_ID, runInInjectionContext, afterNextRender, Directive, Input, SkipSelf, Optional, InjectionToken, TemplateRef, Component, ViewChild, createComponent, EnvironmentInjector, reflectComponentType, ViewContainerRef, booleanAttribute, numberAttribute } from '@angular/core';
