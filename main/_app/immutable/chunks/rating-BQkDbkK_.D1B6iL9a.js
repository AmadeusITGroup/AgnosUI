...
function Rating(props) {
  ...
  return /* @__PURE__ */ jsx("div", { ...useDirectives([useClassDirective("d-inline-flex"), containerDirective]), children: state.stars.map((star) => /* @__PURE__ */ jsx(Star, { star, state, directive: starDirective }, star.index)) });
}
export {
  Rating as R,
  createRating as c
