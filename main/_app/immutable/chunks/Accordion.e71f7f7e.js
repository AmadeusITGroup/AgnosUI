...
export const Accordion = forwardRef(function Accordion(props, ref) {
    ...
    return (_jsx(AccordionDIContext.Provider, { value: widget.api, children: _jsx("div", { className: \`accordion \${state.accordionClass}\`, ref: refSetAccordion, children: props.children }) }));
});
`;export{t as default};
