...
const ToastHeader = (slotContext) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "toast-header", children: [
  ...
  slotContext.state.dismissible && /* @__PURE__ */ jsxRuntime.jsx("button", { ...directive.useDirectives([directive.useClassDirective("btn-close me-0 ms-auto"), slotContext.widget.directives.closeButtonDirective]) })
] });
const ToastCloseButtonNoHeader = (slotContext) => /* @__PURE__ */ jsxRuntime.jsx("button", { ...directive.useDirectives([directive.useClassDirective("btn-close btn-close-white me-2 m-auto"), slotContext.widget.directives.closeButtonDirective]) });
...
const ToastElement = (slotContext) => /* @__PURE__ */ jsxRuntime.jsx(
  "div",
  {
    ...directive.useDirectives([
      directive.useClassDirective(\`toast \${slotContext.state.dismissible ? "toast-dismissible" : ""} \${!slotContext.state.slotHeader ? "d-flex" : ""}\`),
