const e=`import type { ProgressbarContext, ProgressbarWidget, SlotContent } from '@agnos-ui/angular-headless';
...
export declare class ProgressbarComponent extends BaseWidgetDirective<ProgressbarWidget> implements AfterContentChecked, OnChanges {
    readonly defaultSlots: import("@amadeus-it-group/tansu").WritableSignal<Partial<Omit<import("core/dist").ProgressbarProps, \`slot\${string}\`> & {
        slotDefault: SlotContent<import("@agnos-ui/angular-headless").WidgetSlotContext<import("@agnos-ui/angular-headless").AdaptWidgetSlots<import("core/dist").ProgressbarWidget>> & Omit<Omit<import("core/dist").ProgressbarContext, keyof import("@agnos-ui/angular-headless").WidgetSlotContext<any>>, \`slot\${string}\`> & {}>;
        slotContent: SlotContent<import("@agnos-ui/angular-headless").WidgetSlotContext<import("@agnos-ui/angular-headless").AdaptWidgetSlots<import("core/dist").ProgressbarWidget>> & Omit<Omit<import("core/dist").ProgressbarContext, keyof import("@agnos-ui/angular-headless").WidgetSlotContext<any>>, \`slot\${string}\`> & {}>;
    }>, Partial<Omit<import("core/dist").ProgressbarProps, \`slot\${string}\`> & {
        slotDefault: SlotContent<import("@agnos-ui/angular-headless").WidgetSlotContext<import("@agnos-ui/angular-headless").AdaptWidgetSlots<import("core/dist").ProgressbarWidget>> & Omit<Omit<import("core/dist").ProgressbarContext, keyof import("@agnos-ui/angular-headless").WidgetSlotContext<any>>, \`slot\${string}\`> & {}>;
        slotContent: SlotContent<import("@agnos-ui/angular-headless").WidgetSlotContext<import("@agnos-ui/angular-headless").AdaptWidgetSlots<import("core/dist").ProgressbarWidget>> & Omit<Omit<import("core/dist").ProgressbarContext, keyof import("@agnos-ui/angular-headless").WidgetSlotContext<any>>, \`slot\${string}\`> & {}>;
    }>>;
    /**
