...
import type { Widget, WidgetFactory, WidgetProps } from '../types';
/**
 ...
 * @returns the widget
 */
export declare const callWidgetFactoryWithConfig: <W extends Widget>({ factory, defaultConfig, widgetConfig, events, props, }: {
