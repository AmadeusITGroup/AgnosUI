...
Use Page slot to customize the pages view and not this`,fileName:"core/src/components/pagination/pagination.ts",start:{line:237,character:2,position:6983},end:{line:237,character:62,position:7043},type:"(page: number, pageCount: number) => number[]",defaultValue:`(page: number, pageCount: number) => {
...
slotPrevious, slotNext,
slotLast, slotPages,
slotNumberLabel,`,fileName:"core/src/components/pagination/pagination.ts",start:{line:124,character:2,position:3842},end:{line:124,character:48,position:3888},type:"SlotContent<PaginationContext>"}],n=[{name:"isEllipsis",description:"If the page number is -1 return true",fileName:"core/src/components/pagination/pagination.ts",start:{line:335,character:2,position:9339},end:{line:335,character:36,position:9373},type:"(page: number) => boolean"}],i={props:e,state:t,api:n};export{i as d};
