...
function ModalComponent_Conditional_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵproperty("auUseMulti", i0.ɵɵpureFunction2(1, _c5$2, ctx_r0.directives.backdropPortalDirective, ctx_r0.directives.backdropDirective));
} }
...
function ModalComponent_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r0 = i0.ɵɵnextContext();
    i0.ɵɵproperty("auUseMulti", i0.ɵɵpureFunction2(6, _c5$2, ctx_r0.directives.modalPortalDirective, ctx_r0.directives.modalDirective));
    i0.ɵɵadvance();
...
class ModalComponent extends BaseWidgetDirective {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ModalComponent, selectors: [["", "auModal", ""]], contentQueries: function ModalComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        } }, inputs: { animated: [2, "auAnimated", "animated", auBooleanAttribute], backdropTransition: [0, "auBackdropTransition", "backdropTransition"], modalTransition: [0, "auModalTransition", "modalTransition"], visible: [2, "auVisible", "visible", auBooleanAttribute], backdrop: [2, "auBackdrop", "backdrop", auBooleanAttribute], closeOnOutsideClick: [2, "auCloseOnOutsideClick", "closeOnOutsideClick", auBooleanAttribute], container: [0, "auContainer", "container"], ariaCloseButtonLabel: [0, "auAriaCloseButtonLabel", "ariaCloseButtonLabel"], backdropClass: [0, "auBackdropClass", "backdropClass"], closeButton: [2, "auCloseButton", "closeButton", auBooleanAttribute], className: [0, "auClassName", "className"], fullscreen: [2, "auFullscreen", "fullscreen", auBooleanAttribute], structure: [0, "auStructure", "structure"], header: [0, "auHeader", "header"], title: [0, "auTitle", "title"], children: [0, "auChildren", "children"], footer: [0, "auFooter", "footer"], contentData: [0, "auContentData", "contentData"] }, outputs: { visibleChange: "auVisibleChange", beforeClose: "auBeforeClose", hidden: "auHidden", shown: "auShown" }, standalone: true, features: [i0.ɵɵInputTransformsFeature, i0.ɵɵInheritDefinitionFeature, i0.ɵɵStandaloneFeature], attrs: _c3$7, ngContentSelectors: _c4$4, decls: 3, vars: 3, consts: [[3, "auContentAsSlot"], [1, "modal-backdrop", 3, "auUseMulti"], [1, "modal", "d-block", 3, "auUseMulti"], [1, "modal-content"], [3, "auSlot", "auSlotProps"]], template: function ModalComponent_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵprojectionDef();
...
const _c4$3 = (a0, a1) => [a0, a1];
const _c5$1 = (a0, a1, a2, a3) => ({ state: a0, api: a1, directives: a2, displayedPage: a3 });
...
function PaginationDefaultSlotsComponent_ng_template_0_For_1_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const api_r3 = ctx_r0.api;
    const directives_r4 = ctx_r0.directives;
    i0.ɵɵproperty("auUse", i0.ɵɵpureFunction2(6, _c4$3, directives_r4.pageLink, i0.ɵɵpureFunction1(4, _c3$6, page_r5)));
    i0.ɵɵadvance();
    i0.ɵɵproperty("auSlot", state_r2.numberLabel)("auSlotProps", i0.ɵɵpureFunction4(9, _c5$1, state_r2, api_r3, directives_r4, page_r5));
    i0.ɵɵadvance();
...
function SelectComponent_Conditional_0_Conditional_1_For_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵproperty("auUse", i0.ɵɵpureFunction2(3, _c1$5, ctx_r2.directives.badgeAttributesDirective, itemContext_r1));
    i0.ɵɵadvance();
    i0.ɵɵproperty("auSlot", state_r2.badgeLabel)("auSlotProps", i0.ɵɵpureFunction4(6, _c2$5, state_r2, ctx_r2.api, ctx_r2.directives, itemContext_r1));
} }
...
function SelectComponent_Conditional_0_Conditional_3_For_2_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵproperty("auUse", i0.ɵɵpureFunction2(5, _c1$5, ctx_r2.directives.itemAttributesDirective, itemContext_r4));
    i0.ɵɵadvance();
    i0.ɵɵproperty("auSlot", state_r2.itemLabel)("auSlotProps", i0.ɵɵpureFunction4(8, _c2$5, state_r2, ctx_r2.api, ctx_r2.directives, itemContext_r4));
} }
function SelectComponent_Conditional_0_Conditional_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r2 = i0.ɵɵnextContext();
    i0.ɵɵproperty("auUseMulti", i0.ɵɵpureFunction3(1, _c3$5, ctx_r2.directives.hasFocusDirective, ctx_r2.directives.floatingDirective, ctx_r2.directives.menuAttributesDirective));
    i0.ɵɵadvance();
...
function SelectComponent_Conditional_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const state_r2 = ctx;
    const ctx_r2 = i0.ɵɵnextContext();
    i0.ɵɵproperty("auUseMulti", i0.ɵɵpureFunction2(5, _c1$5, ctx_r2.directives.hasFocusDirective, ctx_r2.directives.inputContainerDirective));
    i0.ɵɵadvance();
...
const _c3$3 = ["*"];
const _c4$2 = (a0, a1, a2) => ({ state: a0, api: a1, directives: a2 });
...
class AccordionItemComponent extends BaseWidgetDirective {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: AccordionItemComponent, selectors: [["", "auAccordionItem", ""]], contentQueries: function AccordionItemComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
            ...
            i0.ɵɵproperty("auContentAsSlot", ctx.defaultSlots);
            i0.ɵɵadvance();
            i0.ɵɵproperty("auSlotProps", i0.ɵɵpureFunction3(3, _c4$2, ctx.state(), ctx.api, ctx.directives))("auSlot", ctx.state().structure);
...
function SliderDefaultStructureSlotComponent_ng_template_0_For_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵproperty("auUse", i0.ɵɵpureFunction2(3, _c2$2, directives_r2.progressDisplayDirective, i0.ɵɵpureFunction1(1, _c4$1, option_r1)));
} }
...
class ProgressbarComponent extends BaseWidgetDirective {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ProgressbarComponent, selectors: [["", "auProgressbar", ""]], contentQueries: function ProgressbarComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
            ...
            i0.ɵɵproperty("auContentAsSlot", ctx.defaultSlots);
            i0.ɵɵadvance();
            i0.ɵɵproperty("auSlot", ctx.state().structure)("auSlotProps", i0.ɵɵpureFunction3(3, _c1$1, ctx.state(), ctx.api, ctx.directives));
        } }, dependencies: [SlotDirective, ContentAsSlotDirective], encapsulation: 2, changeDetection: 0 }); }
}
