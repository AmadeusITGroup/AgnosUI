...
export declare class SelectComponent<Item> extends BaseWidgetDirective<SelectWidget<Item>> implements AfterContentChecked {
    ...
    get menuDirective(): import("@agnos-ui/angular-headless").Directive<void, import("@agnos-ui/angular-headless").SSRHTMLElement>;
    get controlContainerDirective(): import("@agnos-ui/angular-headless").Directive<void, import("@agnos-ui/angular-headless").SSRHTMLElement>;
