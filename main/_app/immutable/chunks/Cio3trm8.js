 ...
 */
export declare const ProgressbarDefaultSlotStructure: (slotContext: ProgressbarContext) => import("react").JSX.Element;
/**
 ...
 */
export declare const Progressbar: (props: Partial<ProgressbarProps>) => import("react").JSX.Element;
`;export{r as default};
