...
const Modal = forwardRef(function Modal2(props, ref) {
  ...
  return /* @__PURE__ */ jsxs(Portal, { container: state.container, children: [
    !state.backdropHidden && /* @__PURE__ */ jsx("div", { className: \`modal-backdrop\`, ...refSetBackdrop }),
    !state.hidden && /* @__PURE__ */ jsx("div", { className: \`modal d-block\`, ...refSetModal, children: /* @__PURE__ */ jsx("div", { className: "modal-dialog", children: /* @__PURE__ */ jsx("div", { className: "modal-content", children: /* @__PURE__ */ jsx(Slot, { slotContent: state.slotStructure, props: slotContext }) }) }) })
  ] });
});
