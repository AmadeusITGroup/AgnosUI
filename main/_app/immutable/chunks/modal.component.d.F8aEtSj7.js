const e=`import type { ModalBeforeCloseEvent, ModalContext, ModalProps, ModalWidget, SlotContent, TransitionFn } from '@agnos-ui/angular-headless';
 ...
 * Modal component.
 */
export declare class ModalComponent<Data> extends BaseWidgetDirective<ModalWidget<Data>> implements OnChanges, AfterContentChecked {
    /**
