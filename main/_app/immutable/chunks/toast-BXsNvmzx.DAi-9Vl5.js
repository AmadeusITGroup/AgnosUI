...
const ToastHeader = (slotContext) => /* @__PURE__ */ jsxs("div", { className: "toast-header", children: [
  ...
  slotContext.state.dismissible && /* @__PURE__ */ jsx("button", { ...useDirectives([useClassDirective("btn-close me-0 ms-auto"), slotContext.widget.directives.closeButtonDirective]) })
] });
const ToastCloseButtonNoHeader = (slotContext) => /* @__PURE__ */ jsx("button", { ...useDirectives([useClassDirective("btn-close btn-close-white me-2 m-auto"), slotContext.widget.directives.closeButtonDirective]) });
