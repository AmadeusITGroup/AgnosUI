...
function Star({ star, state, directive: directive$1 }) {
  const starContainer = directive.useDirective(directive$1, { index: star.index });
  return /* @__PURE__ */ jsxRuntime.jsxs(React.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx("span", { ref: starContainer, children: /* @__PURE__ */ jsxRuntime.jsx(slot.Slot, { slotContent: state.slotStar, props: star }) })
  ] }, star.index);
}
