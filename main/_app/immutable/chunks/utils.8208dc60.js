...
export const callWidgetFactory = (factory, widgetName, slots, defaultConfig) => withPatchChangedProps(factory({ config: getContextWidgetConfig(widgetName, slots, defaultConfig) }));
