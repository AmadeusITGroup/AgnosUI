...
export function Rating(props) {
    const [{ tabindex, maxRating, visibleRating, ariaValueText, readonly, disabled, interactive, stars, className, slotStar, ariaLabel, ariaLabelledBy }, widget,] = useWidgetWithConfig(createRating, props, 'rating');
    const starStyle = {
