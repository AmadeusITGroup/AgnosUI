...
const AccordionItem = forwardRef(
  function AccordionItem2(props, ref) {
    ...
    return /* @__PURE__ */ jsx("div", { ...useDirectives([classDirective, \`accordion-item \${state.className}\`], widget.directives.itemDirective), children: /* @__PURE__ */ jsx(Slot, { slotContent: state.slotItemStructure, props: slotContext }) });
  }
);
