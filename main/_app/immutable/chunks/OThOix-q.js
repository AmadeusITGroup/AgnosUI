const e=`$au-slider-color-background: var(--#{$prefix}secondary-bg, #e9ecef) !default;
...
$au-slider-margin-block-end: calc((var(--#{$prefix}slider-handle-size) - var(--#{$prefix}slider-secondary-size)) / 2 + 0.5rem) !default;
$au-slider-margin-block-start: calc(
...
$au-slider-offset-lg: 0rem !default;`;export{e as default};
