...
export declare class ModalComponent implements OnChanges, AfterContentChecked {
    ...
    readonly _widget: import("@agnos-ui/angular-headless").WithPatchSlots<import("@agnos-ui/core").ModalWidget>;
    readonly widget: Pick<import("@agnos-ui/angular-headless").WithPatchSlots<import("@agnos-ui/core").ModalWidget>, "actions" | "api" | "directives" | "state$" | "stores">;
    readonly api: import("@agnos-ui/angular-headless").ModalApi;
