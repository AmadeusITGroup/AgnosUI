const n=`import { createAccordion as createAccordion$1 } from '@agnos-ui/core/components/accordion';
...
import { NgZone, inject, Injectable, signal, DestroyRef, ElementRef, Directive, Input, Injector, runInInjectionContext, SkipSelf, Optional, InjectionToken, TemplateRef, EnvironmentInjector, createComponent, reflectComponentType, ViewContainerRef, booleanAttribute, numberAttribute } from '@angular/core';
