...
export declare class ProgressbarComponent extends BaseWidgetDirective<ProgressbarWidget> implements AfterContentChecked, OnChanges {
    readonly defaultSlots: import("@amadeus-it-group/tansu").WritableSignal<Partial<Omit<import("core/dist/components/progressbar/progressbar").ProgressbarProps, \`slot\${string}\`> & {
        slotDefault: SlotContent<import("@agnos-ui/angular-headless").WidgetSlotContext<import("@agnos-ui/angular-headless").AdaptWidgetSlots<import("core/dist/components/progressbar/progressbar").ProgressbarWidget>> & Omit<Omit<import("core/dist/components/progressbar/progressbar").ProgressbarContext, keyof import("@agnos-ui/angular-headless").WidgetSlotContext<any>>, \`slot\${string}\`> & {}>;
        slotContent: SlotContent<import("@agnos-ui/angular-headless").WidgetSlotContext<import("@agnos-ui/angular-headless").AdaptWidgetSlots<import("core/dist/components/progressbar/progressbar").ProgressbarWidget>> & Omit<Omit<import("core/dist/components/progressbar/progressbar").ProgressbarContext, keyof import("@agnos-ui/angular-headless").WidgetSlotContext<any>>, \`slot\${string}\`> & {}>;
    }>, Partial<Omit<import("core/dist/components/progressbar/progressbar").ProgressbarProps, \`slot\${string}\`> & {
        slotDefault: SlotContent<import("@agnos-ui/angular-headless").WidgetSlotContext<import("@agnos-ui/angular-headless").AdaptWidgetSlots<import("core/dist/components/progressbar/progressbar").ProgressbarWidget>> & Omit<Omit<import("core/dist/components/progressbar/progressbar").ProgressbarContext, keyof import("@agnos-ui/angular-headless").WidgetSlotContext<any>>, \`slot\${string}\`> & {}>;
        slotContent: SlotContent<import("@agnos-ui/angular-headless").WidgetSlotContext<import("@agnos-ui/angular-headless").AdaptWidgetSlots<import("core/dist/components/progressbar/progressbar").ProgressbarWidget>> & Omit<Omit<import("core/dist/components/progressbar/progressbar").ProgressbarContext, keyof import("@agnos-ui/angular-headless").WidgetSlotContext<any>>, \`slot\${string}\`> & {}>;
    }>>;
    /**
