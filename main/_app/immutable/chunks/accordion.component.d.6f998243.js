...
import { ComponentTemplate, UseDirective } from '@agnos-ui/angular-headless';
...
export declare class AccordionItemComponent implements OnChanges, AfterContentChecked, AfterViewInit {
    ...
    defaultSlots: import("@amadeus-it-group/tansu").WritableSignal<Partial<Omit<import("@agnos-ui/core").AccordionItemProps, \`slot\${string}\`> & {
        slotItemHeader: SlotContent<import("@agnos-ui/angular-headless").WidgetSlotContext<import("@agnos-ui/angular-headless").AdaptWidgetSlots<import("@agnos-ui/core").AccordionItemWidget>> & Omit<Omit<import("@agnos-ui/core").AccordionItemContext, keyof import("@agnos-ui/angular-headless").WidgetSlotContext<any>>, \`slot\${string}\`> & {}>;
        slotItemBody: SlotContent<import("@agnos-ui/angular-headless").WidgetSlotContext<import("@agnos-ui/angular-headless").AdaptWidgetSlots<import("@agnos-ui/core").AccordionItemWidget>> & Omit<Omit<import("@agnos-ui/core").AccordionItemContext, keyof import("@agnos-ui/angular-headless").WidgetSlotContext<any>>, \`slot\${string}\`> & {}>;
        slotItemStructure: SlotContent<import("@agnos-ui/angular-headless").WidgetSlotContext<import("@agnos-ui/angular-headless").AdaptWidgetSlots<import("@agnos-ui/core").AccordionItemWidget>> & Omit<Omit<import("@agnos-ui/core").AccordionItemContext, keyof import("@agnos-ui/angular-headless").WidgetSlotContext<any>>, \`slot\${string}\`> & {}>;
    ...
    readonly _widget: import("@agnos-ui/angular-headless").WithPatchSlots<import("@agnos-ui/core").AccordionItemWidget>;
    readonly widget: Pick<import("@agnos-ui/angular-headless").WithPatchSlots<import("@agnos-ui/core").AccordionItemWidget>, "actions" | "api" | "directives" | "state$" | "stores">;
    readonly api: import("@agnos-ui/angular-headless").AccordionItemApi;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AccordionItemComponent, "[auAccordionItem]", ["auAccordionItem"], { "slotItemHeader": { "alias": "auSlotItemHeader"; "required": false; }; "slotItemBody": { "alias": "auSlotItemBody"; "required": false; }; "slotItemStructure": { "alias": "auSlotItemStructure"; "required": false; }; "itemId": { "alias": "auItemId"; "required": false; }; "itemTransition": { "alias": "auItemTransition"; "required": false; }; "itemClass": { "alias": "auItemClass"; "required": false; }; "itemDestroyOnHide": { "alias": "auItemDestroyOnHide"; "required": false; }; "itemDisabled": { "alias": "auItemDisabled"; "required": false; }; "itemCollapsed": { "alias": "auItemCollapsed"; "required": false; }; "itemAnimation": { "alias": "auItemAnimation"; "required": false; }; "itemHeaderClass": { "alias": "auItemHeaderClass"; "required": false; }; "itemButtonClass": { "alias": "auItemButtonClass"; "required": false; }; "itemCollapseClass": { "alias": "auItemCollapseClass"; "required": false; }; "itemBodyClass": { "alias": "auItemBodyClass"; "required": false; }; }, { "itemShown": "auItemShown"; "itemHidden": "auItemHidden"; "itemCollapsedChange": "auItemCollapsedChange"; }, ["slotItemHeaderFromContent", "slotItemBodyFromContent", "slotItemStructureFromContent"], never, true, [{ directive: typeof i1.UseDirective; inputs: {}; outputs: {}; }]>;
}
export declare class AccordionDirective implements OnChanges {
     ...
     */
    itemCollapsedChange: EventEmitter<boolean>;
    readonly _widget: import("@agnos-ui/angular-headless").WithPatchSlots<import("@agnos-ui/core").AccordionWidget>;
    readonly api: import("@agnos-ui/angular-headless").AccordionApi;
    state$: Signal<AccordionState>;
    constructor();
    ngOnChanges(changes: SimpleChanges): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<AccordionDirective, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<AccordionDirective, "[auAccordion]", ["auAccordion"], { "closeOthers": { "alias": "auCloseOthers"; "required": false; }; "className": { "alias": "auClassName"; "required": false; }; "itemId": { "alias": "auItemId"; "required": false; }; "itemDestroyOnHide": { "alias": "auItemDestroyOnHide"; "required": false; }; "itemDisabled": { "alias": "auItemDisabled"; "required": false; }; "itemCollapsed": { "alias": "auItemCollapsed"; "required": false; }; "itemAnimation": { "alias": "auItemAnimation"; "required": false; }; "itemTransition": { "alias": "auItemTransition"; "required": false; }; "slotItemStructure": { "alias": "auSlotItemStructure"; "required": false; }; "slotItemBody": { "alias": "auSlotItemBody"; "required": false; }; "slotItemHeader": { "alias": "auSlotItemHeader"; "required": false; }; "itemClass": { "alias": "auItemClass"; "required": false; }; "itemHeaderClass": { "alias": "auItemHeaderClass"; "required": false; }; "itemButtonClass": { "alias": "auItemButtonClass"; "required": false; }; "itemCollapseClass": { "alias": "auItemCollapseClass"; "required": false; }; "itemBodyClass": { "alias": "auItemBodyClass"; "required": false; }; }, { "shown": "auShown"; "hidden": "auHidden"; "itemShown": "auItemShown"; "itemHidden": "auItemHidden"; "itemCollapsedChange": "auItemCollapsedChange"; }, never, never, true, [{ directive: typeof i1.UseDirective; inputs: {}; outputs: {}; }]>;
}
`;export{e as default};
