const e=`--#{variables.$prefix}tree-item-padding-start: #{variables.$au-tree-item-padding-start};
...
--#{variables.$prefix}tree-expand-icon-hover: #{functions.escape-svg(variables.$au-tree-expand-icon-hover)};`;export{e as default};
