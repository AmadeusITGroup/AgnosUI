const t=`.au-slider.au-custom-slider-container {
	@media (max-width: 576px) {
		width: 95%;
	}
}
.au-custom-slider-handle {
	...
	&:focus,
	&:focus-within {
		border-bottom: 0.15rem solid var(--bs-slider-handle-color);
	}
}
.au-custom-slider-handle-horizontal {
...
.coffee-indicator {
	...
	&::before {
		...
		border-left: 25px solid var(--bs-body-color);
		border-top: 18px solid transparent;
		border-bottom: 18px solid transparent;
		@media (min-width: 576px) {
			border-left: 35px solid var(--bs-body-color);
			border-top: 23px solid transparent;
			border-bottom: 23px solid transparent;
		}
	}
	&:focus {
		box-shadow: 0 0 1rem 0.5rem var(--bs-slider-handle-color);
	}
}
`;export{t as default};
