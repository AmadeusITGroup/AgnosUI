...
export declare class CollapseDirective extends BaseWidgetDirective<CollapseWidget> {
    ...
    readonly _widget: import("@agnos-ui/angular-headless").AngularWidget<CollapseWidget>;
    static ɵfac: i0.ɵɵFactoryDeclaration<CollapseDirective, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<CollapseDirective, "[auCollapse]", ["auCollapse"], { "animatedOnInit": { "alias": "auAnimatedOnInit"; "required": false; }; "animated": { "alias": "auAnimated"; "required": false; }; "className": { "alias": "auClassName"; "required": false; }; "horizontal": { "alias": "auHorizontal"; "required": false; }; "visible": { "alias": "auVisible"; "required": false; }; }, { "visibleChange": "auVisibleChange"; "hidden": "auHidden"; "shown": "auShown"; }, never, never, true, never>;
