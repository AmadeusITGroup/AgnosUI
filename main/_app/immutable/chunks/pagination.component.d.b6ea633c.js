const e=`import type { WidgetProps, PaginationContext as PaginationCoreContext, PaginationNumberContext as PaginationNumberCoreContext, WidgetState } from '@agnos-ui/core';
...
export declare class PaginationComponent implements OnChanges, AfterContentChecked {
    ...
    readonly _widget: import("../slot.directive").WithPatchSlots<import("@agnos-ui/core").PaginationWidget>;
    readonly widget: Pick<import("../slot.directive").WithPatchSlots<import("@agnos-ui/core").PaginationWidget>, "api" | "actions" | "directives" | "state$" | "stores">;
    readonly api: import("@agnos-ui/core").PaginationApi;
