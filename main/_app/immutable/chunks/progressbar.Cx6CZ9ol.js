...
export const Progressbar = (props) => {
    ...
    return (_jsx("div", { role: "progressbar", "aria-label": state.ariaLabel || undefined, "aria-valuenow": state.value, "aria-valuemin": state.min, "aria-valuemax": state.max, "aria-valuetext": state.ariaValueText, children: _jsx(Slot, { slotContent: state.slotStructure, props: slotContext }) }));
};
`;export{t as default};
