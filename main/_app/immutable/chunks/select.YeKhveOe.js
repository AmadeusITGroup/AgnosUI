...
function Rows({ slotContext }) {
    ...
    return (_jsx(_Fragment, { children: state.visibleItems.map((itemContext) => {
            ...
            return (_jsx("li", { role: "option", "aria-selected": itemContext.selected, className: classname.join(' '), onClick: () => widget.api.toggleItem(itemContext.item), style: { cursor: 'pointer' }, children: _jsx(Slot, { slotContent: state.slotItem, props: { ...slotContext, itemContext } }) }, id));
        }) }));
}
const defaultConfig = {
