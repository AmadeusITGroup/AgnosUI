...
declare const __propDef: {
    props: WidgetSlotContext<Widget<import("./slider.gen").SliderProps, import("./slider.gen").SliderState, object, import("./slider.gen").SliderActions, import("./slider.gen").SliderDirectives>>;
    events: {
