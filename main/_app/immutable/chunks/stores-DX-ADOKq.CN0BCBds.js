const e=`import { readable, writable, asReadable, batch, computed, asWritable, get, derived, equal } from "@amadeus-it-group/tansu";
import { INVALID_VALUE } from "./types.js";
import { noop, identity } from "./utils/func.js";
...
export {
  mergeConfigStores as A,
  writablesWithDefault as B,
  writablesForProps as C,
  stateStores as D,
  bindableDerived as E,
  bindableProp as F,
  idWithDefault as G,
  generateId as H,
  addEvent as I,
  ...
  ssrAttributes as s,
  createPatch as t,
  findChangedProperties as u,
  isStore as v,
  writableWithDefault as w,
  toReadableStore as x,
  toWritableStore as y,
  normalizeConfigStores as z
};
`;export{e as default};
