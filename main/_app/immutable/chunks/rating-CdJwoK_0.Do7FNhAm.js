...
import { useDirective, ssrAttributes } from "@agnos-ui/react-headless/utils/directive";
...
function Star({ star, state, directive }) {
  ...
  return /* @__PURE__ */ jsxs(React__default.Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("span", { ref: starContainer, ...ssrAttributes([directive, arg]), children: /* @__PURE__ */ jsx(Slot, { slotContent: state.slotStar, props: star }) })
  ] }, star.index);
}
