...
function Rows({ slotContext, menuId }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "ul",
    {
      ...
      ...directive.useDirectives([directive.classDirective, \`dropdown-menu show \${menuClassName}\`], hasFocusDirective, floatingDirective),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { ...directive.useDirectives([directive.classDirective, \`au-select dropdown border border-1 p-1 mb-3 d-block \${className}\`], referenceDirective), children: [
    /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        "aria-expanded": open,
        ...directive.useDirectives([directive.classDirective, "d-flex align-items-center flex-wrap"], hasFocusDirective, inputContainerDirective),
        children: [
