...
function CarouselDefaultSlotsComponent_ng_template_0_Conditional_0_Conditional_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const directives_r1 = i0.ɵɵnextContext(2).directives;
    i0.ɵɵproperty("auUse", directives_r1.scrollPrev);
} }
function CarouselDefaultSlotsComponent_ng_template_0_Conditional_0_Conditional_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const directives_r1 = i0.ɵɵnextContext(2).directives;
    i0.ɵɵproperty("auUse", directives_r1.scrollNext);
} }
function CarouselDefaultSlotsComponent_ng_template_0_Conditional_0_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵtemplate(0, CarouselDefaultSlotsComponent_ng_template_0_Conditional_0_Conditional_0_Template, 2, 1, "button", 5)(1, CarouselDefaultSlotsComponent_ng_template_0_Conditional_0_Conditional_1_Template, 2, 1, "button", 6);
} if (rf & 2) {
    const state_r2 = i0.ɵɵnextContext().state;
...
function CarouselDefaultSlotsComponent_ng_template_0_Conditional_1_For_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const slideData_r3 = ctx.$implicit;
    const ɵ$index_17_r4 = ctx.$index;
    const directives_r1 = i0.ɵɵnextContext(2).directives;
    i0.ɵɵproperty("auUse", i0.ɵɵpureFunction2(4, _c3, directives_r1.tabIndicator, i0.ɵɵpureFunction2(1, _c2, ɵ$index_17_r4, slideData_r3.id)));
} }
function CarouselDefaultSlotsComponent_ng_template_0_Conditional_1_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 4);
    i0.ɵɵrepeaterCreate(1, CarouselDefaultSlotsComponent_ng_template_0_Conditional_1_For_2_Template, 1, 7, "button", 9, _forTrack0$1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const state_r2 = i0.ɵɵnextContext().state;
    i0.ɵɵadvance();
...
function CarouselDefaultSlotsComponent_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵtemplate(0, CarouselDefaultSlotsComponent_ng_template_0_Conditional_0_Template, 2, 2)(1, CarouselDefaultSlotsComponent_ng_template_0_Conditional_1_Template, 3, 0, "div", 4);
} if (rf & 2) {
    const state_r2 = ctx.state;
...
function CarouselDefaultSlotsComponent_ng_template_2_For_3_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 9);
    i0.ɵɵtemplate(1, CarouselDefaultSlotsComponent_ng_template_2_For_3_ng_template_1_Template, 0, 0, "ng-template", 10);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const slideData_r5 = ctx.$implicit;
    const ɵ$index_26_r6 = ctx.$index;
    const ctx_r6 = i0.ɵɵnextContext();
    const state_r8 = ctx_r6.state;
    const api_r9 = ctx_r6.api;
    const directives_r10 = ctx_r6.directives;
    const ctx_r10 = i0.ɵɵnextContext();
    i0.ɵɵproperty("auUse", i0.ɵɵpureFunction2(6, _c3, directives_r10.slide, i0.ɵɵpureFunction2(3, _c2, ɵ$index_26_r6, slideData_r5.id)));
    i0.ɵɵadvance();
    i0.ɵɵproperty("auSlot", state_r8.slide())("auSlotProps", ctx_r10.toSlideContext(slideData_r5, i0.ɵɵpureFunction3(9, _c4, state_r8, api_r9, directives_r10)));
} }
function CarouselDefaultSlotsComponent_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵtemplate(0, CarouselDefaultSlotsComponent_ng_template_2_ng_template_0_Template, 0, 0, "ng-template", 10);
    i0.ɵɵelementStart(1, "div", 11);
    i0.ɵɵrepeaterCreate(2, CarouselDefaultSlotsComponent_ng_template_2_For_3_Template, 2, 13, "div", 9, _forTrack0$1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const state_r8 = ctx.state;
    const api_r9 = ctx.api;
    const directives_r10 = ctx.directives;
    i0.ɵɵproperty("auSlot", state_r8.navigation())("auSlotProps", i0.ɵɵpureFunction3(2, _c4, state_r8, api_r9, directives_r10));
    i0.ɵɵadvance(2);
    i0.ɵɵrepeater(state_r8.slidesData());
} }
...
class CarouselDefaultSlotsComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: CarouselDefaultSlotsComponent, selectors: [["ng-component"]], viewQuery: function CarouselDefaultSlotsComponent_Query(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵqueryAdvance(2);
        } }, decls: 4, vars: 0, consts: [["navigation", ""], ["structure", ""], ["auCarouselNavigation", ""], ["auCarouselStructure", ""], ["role", "tablist", 1, "carousel-indicators"], [1, "carousel-control-prev", 3, "auUse"], [1, "carousel-control-next", 3, "auUse"], [1, "carousel-control-prev-icon"], [1, "carousel-control-next-icon"], [3, "auUse"], [3, "auSlot", "auSlotProps"], ["aria-atomic", "false", "aria-live", "polite", 1, "au-carousel-container"]], template: function CarouselDefaultSlotsComponent_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵtemplate(0, CarouselDefaultSlotsComponent_ng_template_0_Template, 2, 2, "ng-template", 2, 0, i0.ɵɵtemplateRefExtractor)(2, CarouselDefaultSlotsComponent_ng_template_2_Template, 4, 6, "ng-template", 3, 1, i0.ɵɵtemplateRefExtractor);
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(CarouselDefaultSlotsComponent, { className: "CarouselDefaultSlotsComponent", filePath: "components/carousel/carousel.component.ts", lineNumber: 101 }); })();
/**
 * The default slot for the structure
 */
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(CarouselComponent, { className: "CarouselComponent", filePath: "components/carousel/carousel.component.ts", lineNumber: 132 }); })();
