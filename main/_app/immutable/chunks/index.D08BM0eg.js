...
const accordion = require("./accordion-WFh8_JbE.cjs");
...
const progressbar = require("./progressbar-D3-Bb2T-.cjs");
const rating = require("./rating-DnDs7jY4.cjs");
const select = require("./select-BJghLJE1.cjs");
const slider = require("./slider-BYQiyos1.cjs");
const toast = require("./toast-CdFwwGK_.cjs");
