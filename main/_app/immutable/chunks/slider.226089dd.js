...
export function createSlider(config) {
    ...
    min$: _dirtyMinimum$, max$: _dirtyMaximum$, stepSize$, values$: _dirtyValues$, ariaLabelHandle$, onValuesChange$, showValueLabels$, showMinMaxLabels$, ...stateProps }, patch,] = writablesForProps(defaultSliderConfig, config, configValidator);
