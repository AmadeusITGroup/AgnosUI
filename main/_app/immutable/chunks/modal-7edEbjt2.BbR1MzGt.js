...
const Modal = React.forwardRef(function Modal2(props, ref) {
  const [state, widget] = config.useWidgetWithConfig(modal.createModal, props, "modal", { ...defaultConfig, slotDefault: props.children });
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(portal.Portal, { container: state.container, children: [
    state.backdropHidden ? null : /* @__PURE__ */ jsxRuntime.jsx("div", { className: \`modal-backdrop \${state.backdropClass}\`, ref: refSetBackdrop }),
    state.hidden ? null : /* @__PURE__ */ jsxRuntime.jsx("div", { className: \`modal d-block \${state.className}\`, ref: refSetModal, onClick: widget.actions.modalClick, children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "modal-dialog", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "modal-content", children: /* @__PURE__ */ jsxRuntime.jsx(slot.Slot, { slotContent: state.slotStructure, props: slotContext }) }) }) })
  ] });
});
