...
for I18n, we suggest to use the global configuration
override any configuration parameters provided for this`,fileName:"core/src/components/pagination/pagination.ts",start:{line:91,character:2,position:2813},end:{line:91,character:24,position:2835},type:"string",defaultValue:"'Action link for last page'"},{name:"ariaNextLabel",description:`The label for the "Next" page button.
for I18n, we suggest to use the global configuration
...
for I18n, we suggest to use the global configuration
override any configuration parameters provided for this`,fileName:"core/src/components/pagination/pagination.ts",start:{line:91,character:2,position:2813},end:{line:91,character:24,position:2835},type:"string"},{name:"ariaNextLabel",description:`The label for the "Next" page button.
for I18n, we suggest to use the global configuration
...
for I18n, we suggest to use the global configuration
override any configuration parameters provided for this`,fileName:"core/src/components/pagination/pagination.ts",start:{line:75,character:2,position:2329},end:{line:75,character:28,position:2355},type:"string"},{name:"boundaryLinks",description:'If `true`, the "First" and "Last" page links are shown.',fileName:"core/src/components/pagination/pagination.ts",start:{line:117,character:2,position:3397},end:{line:117,character:25,position:3420},type:"boolean"},{name:"className",description:"CSS classes to be applied on the widget main container",fileName:"core/src/components/commonProps.ts",start:{line:5,character:2,position:116},end:{line:5,character:20,position:134},type:"string"},{name:"directionLinks",description:'If `true`, the "Next" and "Previous" page links are shown.',fileName:"core/src/components/pagination/pagination.ts",start:{line:111,character:2,position:3276},end:{line:111,character:26,position:3300},type:"boolean"},{name:"directionsHrefs",description:"The hrefs for the direction links",fileName:"core/src/components/pagination/pagination.ts",start:{line:304,character:2,position:8721},end:{line:304,character:35,position:8754},type:"DirectionsHrefs"},{name:"disabled",description:"If `true`, pagination links will be disabled.",fileName:"core/src/components/pagination/pagination.ts",start:{line:105,character:2,position:3159},end:{line:105,character:20,position:3177},type:"boolean"},{name:"nextDisabled",description:"true if the next link need to be disabled",fileName:"core/src/components/pagination/pagination.ts",start:{line:294,character:2,position:8511},end:{line:294,character:24,position:8533},type:"boolean"},{name:"page",description:"The current page.\n\nPage numbers start with `1`.",fileName:"core/src/components/pagination/pagination.ts",start:{line:34,character:2,position:1208},end:{line:34,character:15,position:1221},type:"number"},{name:"pageCount",description:"The number of pages.",fileName:"core/src/components/pagination/pagination.ts",start:{line:282,character:2,position:8245},end:{line:282,character:20,position:8263},type:"number"},{name:"pages",description:"The current pages, the number in the Array is the number of the page.",fileName:"core/src/components/pagination/pagination.ts",start:{line:286,character:2,position:8349},end:{line:286,character:18,position:8365},type:"number[]"},{name:"pagesHrefs",description:'The hrefs for each "Page" page link',fileName:"core/src/components/pagination/pagination.ts",start:{line:301,character:2,position:8654},end:{line:301,character:23,position:8675},type:"string[]"},{name:"pagesLabel",description:'The label for each "Page" page link.',fileName:"core/src/components/pagination/pagination.ts",start:{line:298,character:2,position:8586},end:{line:298,character:23,position:8607},type:"string[]"},{name:"previousDisabled",description:"true if the previous link need to be disabled",fileName:"core/src/components/pagination/pagination.ts",start:{line:290,character:2,position:8427},end:{line:290,character:28,position:8453},type:"boolean"},{name:"size",description:`The pagination display size.
