...
\r
export declare interface AccordionApi {\r
    /**\r
     * Given the itemId, it will return if such item is expanded or not.\r
     *\r
     * If the itemId is not a valid id it will return \`false\`.\r
     */\r
    isExpanded(itemId: string): boolean;\r
    /**\r
     * Given the itemId, will expand the corresponding accordion-item.\r
     *\r
     * If the itemId is not valid, nothing will happen.\r
     */\r
    expand(itemId: string): void;\r
    /**\r
     * Given the itemId, will collapse the corresponding accordion-item.\r
     *\r
     * If the itemId is not valid, nothing will happen.\r
     */\r
    collapse(itemId: string): void;\r
    /**\r
     * Given the itemId, will toggle the corresponding accordion-item.\r
     *\r
     * If the itemId is not valid, nothing will happen.\r
     */\r
    toggle(itemId: string): void;\r
    /**\r
     * It will expand all the items in the accordion.\r
     *\r
     * If \`closeOthers\` is \`true\` it will expand only the last accordion-item.\r
     */\r
    expandAll(): void;\r
    /**\r
     * It will collapse all the accordion-items in the accordion.\r
     */\r
    collapseAll(): void;\r
    /**\r
     * Creates a new in accordionItem.\r
     */\r
    registerItem(itemConfig?: PropsConfig<AccordionItemProps>): AccordionItemWidget;\r
}\r
\r
export declare interface AccordionCommonPropsAndState {\r
    /**\r
     * Classes to add on the accordion DOM element.\r
     */\r
    accordionClass: string;\r
}\r
\r
export declare interface AccordionDirectives {\r
    /**\r
     * Directive to put on the accordion DOM element\r
     */\r
    accordionDirective: Directive;\r
}\r
\r
export declare interface AccordionItemActions {\r
    /**\r
     * Action to be called when the user clicks on the accordion-item button. If the accordion-item is disabled nothing will happen.\r
     */\r
    click(): void;\r
}\r
\r
export declare interface AccordionItemApi {\r
    /**\r
     * It will collapse the accordion-item.\r
     */\r
    collapse(): void;\r
    /**\r
     * It will expand the accordion-item.\r
     */\r
    expand(): void;\r
    /**\r
     * It will toggle the accordion-item.\r
     */\r
    toggle(): void;\r
    /**\r
     * Method to be called after the initialization to allow animations.\r
     */\r
    initDone(): void;\r
}\r
\r
export declare interface AccordionItemCommonPropsAndState {\r
    /**\r
     * If \`true\`, the accordion-item will be collapsed. Otherwise, it will be expanded.\r
     */\r
    itemCollapsed: boolean;\r
    /**\r
     * If \`true\`, the accordion-item will be disabled.\r
     * It will not react to user's clicks, but still will be possible to toggle programmatically.\r
     */\r
    itemDisabled: boolean;\r
    /**\r
     * The id of the accordion-item. It can be used for controlling the accordion-item via the accordion api.\r
     */\r
    itemId: string;\r
    /**\r
     * Content present in the accordion button inside the accordion header.\r
     */\r
    slotItemHeader: SlotContent<AccordionItemContext>;\r
    /**\r
     * Content present in the accordion body.\r
     */\r
    slotItemBody: SlotContent<AccordionItemContext>;\r
    /**\r
     * Structure of the accordion-item. The default item structure is: accordion-item\r
     * contains accordion header and accordion collapse; the accordion header contains the accordion button\r
     * (that contains \`slotItemHeader\`), while the accordion collapse contains the accordion body (that contains slotItemBody).\r
     */\r
    slotItemStructure: SlotContent<AccordionItemContext>;\r
    /**\r
     * Classes to add on the accordion-item DOM element.\r
     */\r
    itemClass: string;\r
    /**\r
     * Classes to add on the accordion-item header DOM element.\r
     */\r
    itemHeaderClass: string;\r
    /**\r
     * Classes to add on the accordion-item collapse DOM element.\r
     */\r
    itemButtonClass: string;\r
    /**\r
     * Classes to add on the accordion-item collapse DOM element.\r
     */\r
    itemCollapseClass: string;\r
    /**\r
     * Classes to add on the accordion-item body DOM element.\r
     */\r
    itemBodyClass: string;\r
}\r
\r
export declare type AccordionItemContext = WidgetSlotContext<AccordionItemWidget>;\r
\r
export declare interface AccordionItemDirectives {\r
    /**\r
     * Directive to be put on the accordion-item collapse. It will handle the animation.\r
     */\r
    collapseDirective: Directive;\r
    /**\r
     * Directive to be put on the accordion-item. It will handle adding the accordion-item to the accordion.\r
     */\r
    accordionItemDirective: Directive;\r
}\r
\r
export declare interface AccordionItemProps extends AccordionItemCommonPropsAndState {\r
    /**\r
     * If \`true\`, accordion-item will be animated.\r
     */\r
    itemAnimation: boolean;\r
    /**\r
     * The transition to use for the accordion-item collapse when is toggled.\r
     */\r
    itemTransition: TransitionFn;\r
    /**\r
     * If \`true\`, the content of the accordion-item collapse will be removed from the DOM. It will be just hidden otherwise.\r
     */\r
    itemDestroyOnHide: boolean;\r
    /**\r
     * An event fired when an item is shown.\r
     */\r
    onItemShown: () => void;\r
    /**\r
     * An event fired when an item is hidden.\r
     */\r
    onItemHidden: () => void;\r
    /**\r
     * An event fired when the \`collapsed\` value changes.\r
     *\r
     * Event payload is the new value of collapsed.\r
     */\r
    onItemCollapsedChange: (collapsed: boolean) => void;\r
}\r
\r
export declare interface AccordionItemState extends AccordionItemCommonPropsAndState {\r
    /**\r
     * If \`true\` the collapse inside the accordion-item should be in DOM. Its value depends on the\r
     * value of the \`itemCollapse\` and \`itemDestroyOnHide\`.\r
     */\r
    shouldBeInDOM: boolean;\r
}\r
\r
export declare type AccordionItemWidget = Widget<AccordionItemProps, AccordionItemState, AccordionItemApi, AccordionItemActions, AccordionItemDirectives>;\r
\r
export declare interface AccordionProps extends AccordionCommonPropsAndState {\r
    /**\r
     * If \`true\`, only one item at the time can stay open.\r
     */\r
    closeOthers: boolean;\r
    /**\r
     * An event fired when an item is shown.\r
     *\r
     * Event payload is the id of the item.\r
     */\r
    onShown: (itemId: string) => void;\r
    /**\r
     * An event fired when an item is hidden.\r
     *\r
     * Event payload is the id of the item.\r
     */\r
    onHidden: (itemId: string) => void;\r
    /**\r
     * The id of the accordion-item. It can be used for controlling the accordion-item via the accordion api.\r
     *\r
     * It is a prop of the accordion-item.\r
     */\r
    itemId: string;\r
    /**\r
     * If \`true\`, the content of the accordion-item collapse will be removed from the DOM. It will be just hidden otherwise.\r
    ...
    itemHeaderClass: string;\r
    /**\r
     * Classes to add on the accordion-item toggle button DOM element.\r
     *\r
     * It is a prop of the accordion-item.\r
     */\r
    itemButtonClass: string;\r
...
\r
export declare interface AccordionState extends AccordionCommonPropsAndState {\r
    /**\r
     * Array containing all the accordion-items contained in the accordion.\r
     */\r
    itemsWidget: AccordionItemWidget[];\r
}\r
\r
export declare type AccordionWidget = Widget<AccordionProps, AccordionState, AccordionApi, object, AccordionDirectives>;\r
\r
...
export declare interface AlertCommonPropsAndState {\r
    ...
    /**\r
     * Type of the alert.\r
     * There are the following types: 'success', 'info', 'warning', 'danger', 'primary', 'secondary', 'light' and 'dark'.\r
     */\r
    type: string;\r
    /**\r
...
export declare interface AlertDirectives {\r
    /**\r
     * the transition directive, piloting what is the visual effect of going from hidden to visible\r
     */\r
...
export declare interface AlertState extends AlertCommonPropsAndState {\r
    /**\r
     * Is \`true\` when the alert is hidden. Compared to \`visible\`, this is updated after the transition is executed.\r
     */\r
    hidden: boolean;\r
}\r
\r
...
\r
/**\r
 * Creates a new Accordion widget instance.\r
 * @param config - config of the accordion, either as a store or as an object containing values or stores.\r
 * @returns a new accordion widget instance\r
 */\r
export declare function createAccordion(config?: PropsConfig<AccordionProps>): AccordionWidget;\r
\r
/**\r
 * Create an AlertWidget with given config props\r
 * @param config - an optional alert config\r
 * @returns an AlertWidget\r
 */\r
...
\r
/**\r
 * Create a PaginationWidget with given config props\r
 * @param config - an optional alert config\r
 * @returns a PaginationWidget\r
 */\r
...
\r
/**\r
 * Create a RatingWidget with given config props\r
 * @param config - an optional alert config\r
 * @returns a RatingWidget\r
 */\r
export declare function createRating(config?: PropsConfig<RatingProps>): RatingWidget;\r
\r
/**\r
 * Create a SelectWidget with given config props\r
 * @param config - an optional alert config\r
 * @returns a SelectWidget\r
 */\r
 ...
 * @returns the object with changed properties\r
 */\r
export declare function findChangedProperties<T extends Record<string, any>>(obj1: Partial<T>, obj2: Partial<T>): Partial<T> | null;\r
\r
/**\r
 * Retrieve a shallow copy of the default accordion config\r
 * @returns the default accordion config\r
 */\r
export declare function getAccordionDefaultConfig(): AccordionProps;\r
\r
/**\r
 * Retrieve a shallow copy of the default alert config\r
 * @returns the default alert config\r
 */\r
export declare function getAlertDefaultConfig(): AlertProps;\r
\r
/**\r
...
\r
/**\r
 * Returns a shallow copy of the default pagination config\r
 * @returns a copy of the default config\r
 */\r
...
\r
/**\r
 * Returns a shallow copy of the default rating config.\r
 * @returns a copy of the default config\r
 */\r
...
\r
/**\r
 * Retrieve the transition duration of the provided html element in milli seconds\r
 * @param element - the html element\r
 * @returns transition duration in milli seconds\r
 */\r
...
\r
/**\r
 * Check if the provided html element has a transition\r
 * @param element - the html element\r
 * @returns true if the element has a transition\r
 */\r
...
\r
/**\r
 * This is the pagination algorithm used by ng-bootstrap. While this is not the default implementation of our widget, we export it to ease the migration from ng-bootstrap pagination.\r
 * @param maxSize - the max size\r
 * @param rotate - rotate the pages\r
 * @param ellipses - enable ellipses\r
 * @returns the pages\r
 */\r
...
export declare interface RatingState extends RatingCommonPropsAndState {\r
    /**\r
     * the aria value of the rating\r
     */\r
    ariaValueText: string;\r
    /**\r
     * the visible value of the rating (it changes when hovering over the rating even though the real value did not change)\r
     */\r
    visibleRating: number;\r
    /**\r
     * is the rating interactive i.e. listening to hover, click and keyboard events\r
     */\r
...
export declare interface SelectApi<Item> {\r
    ...
    /**\r
     * Focus the first element\r
     */\r
    focusFirst(): void;\r
    /**\r
     * Focus the previous element. If no element was focused before the call, nothing happens.\r
     */\r
    focusPrevious(): void;\r
    /**\r
     * Focus the next element. If no element was focused before the call, nothing happens.\r
     */\r
    focusNext(): void;\r
    /**\r
     * Focus the last element. If no element was focused before the call, nothing happens.\r
     */\r
    focusLast(): void;\r
    /**\r
     * Select the provided item.\r
     * The selected list is used to\r
     * @param item - the item to select\r
     */\r
    select(item: Item): void;\r
    /**\r
     * Unselect the provided item.\r
     * @param item - the item to unselect\r
     */\r
    unselect(item: Item): void;\r
    /**\r
     * Toggle the selection of an item\r
     * @param item - the item to toggle\r
     * @param selected - an optional boolean to enforce the selected/unselected state instead of toggling\r
     */\r
...
export declare interface SelectCommonPropsAndState<Item> {\r
    /**\r
     * the class to attach to the select DOM element\r
     */\r
    className: string;\r
    /**\r
...
export declare interface SimpleClassTransitionConfig {\r
    /**\r
     * a list of classes to add to the collapsable element while transitioning\r
     */\r
    animationPendingClasses?: string[];\r
    /**\r
     * a list of classes to add to the collapsable element while transitioning towards the show state\r
     */\r
    animationPendingShowClasses?: string[];\r
    /**\r
     * a list of classes to add to the collapsable element while transitioning towards the hide state\r
     */\r
    animationPendingHideClasses?: string[];\r
    /**\r
     * the list of classes to add to the element when shown\r
     */\r
    showClasses?: string[];\r
    /**\r
     * the list of classes to add to the element when hidden\r
     */\r
...
export declare interface SimpleClassTransitionContext {\r
    /**\r
     * \`true\` is the transition has started\r
     */\r
    started?: boolean;\r
}\r
\r
...
export declare interface StarContext {\r
    /**\r
     * indicates how much the current star is filled, from 0 to 100\r
     */\r
    fill: number;\r
    /**\r
     * the position of the star in the rating\r
     */\r
    index: number;\r
}\r
\r
...
export declare interface Widget<Props extends object = object, State extends object = object, Api extends object = object, Actions extends object = object, Directives extends object = object> {\r
    /**\r
     * the reactive state of the widget, combining all the values served by the stores\r
     */\r
    state$: ReadableSignal<State>;\r
    /**\r
     * the different stores of the widget, all reactive\r
     */\r
    stores: {\r
    ...
    /**\r
     * directives to be used on html elements in the template of the widget or in the slots\r
     */\r
    directives: Directives;\r
    /**\r
     * all the handlers that should be connected to user interactions i.e. click, keyboard and touch interactions.\r
     * typically, the handlers are event listeners that call api functions to affect the widget state\r
     */\r
    actions: Actions;\r
    /**\r
     * all the api functions to interact with the widget\r
     */\r
    api: Api;\r
}\r
\r
...
export declare interface WidgetsConfig {\r
    /**\r
     * the pagination widget config\r
     */\r
    pagination: PaginationProps;\r
    /**\r
     * the rating widget config\r
     */\r
    rating: RatingProps;\r
    /**\r
     * the select widget config\r
     */\r
    select: SelectProps<any>;\r
    /**\r
     * the modal widget config\r
     */\r
    modal: ModalProps;\r
    /**\r
     * the alert widget config\r
     */\r
    alert: AlertProps;\r
    /**\r
     * the accordion widget config\r
     */\r
    accordion: AccordionProps;\r
}\r
\r
...
export declare interface WritableWithDefaultOptions<T, U = T> {\r
    /**\r
     * the normalize value function. should return the invalidValue symbol when the provided value is invalid\r
     */\r
    normalizeValue?: NormalizeValue<T, U>;\r
    /**\r
     * the equal function, allowing to compare two values. used to check if a previous and current values are equals.\r
     */\r
