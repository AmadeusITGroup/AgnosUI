const e=`import type { AngularWidget, IsSlotContent, Partial2Levels, SlotContent, Widget, WidgetFactory, WidgetProps, WidgetsConfigStore } from '@agnos-ui/angular-headless';
 ...
 * \`\`\`
 */
export declare const provideWidgetsConfig: (adaptParentConfig?: AdaptParentConfig) => FactoryProvider;
/**
 ...
 */
export declare const injectWidgetsConfig: InjectWidgetsConfig;
/**
 ...
 */
export declare const injectWidgetConfig: <N extends keyof BootstrapWidgetsConfig>(widgetName: N) => ReadableSignal<Partial<WidgetsConfig[N]> | undefined>;
/**
 ...
 */
export declare const callWidgetFactory: <W extends Widget<object, object, object, object>>(factory: WidgetFactory<W>, options?: {
