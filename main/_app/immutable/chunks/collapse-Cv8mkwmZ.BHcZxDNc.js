...
const Collapse = React.forwardRef(
  function Collapse2(props, ref) {
    const [_state, widget] = generated_config.useWidgetWithConfig(export_createCollapse, props, "collapse", {});
    React.useImperativeHandle(ref, () => widget.api, []);
    return /* @__PURE__ */ jsxRuntime.jsx("div", { ...directive.useDirectives(widget.directives.transitionDirective), children: props.children });
  }
);
