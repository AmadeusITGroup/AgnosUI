...
const DefaultSlotStructure = (slotContext) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    slotContext.state.slotHeader && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "toast-header", children: [
      ...
      slotContext.state.dismissible && /* @__PURE__ */ jsxRuntime.jsx("button", { className: "btn-close me-0 ms-auto", ref: refCloseButton })
    ] }),
    ...
    slotContext.state.dismissible && !slotContext.state.slotHeader && /* @__PURE__ */ jsxRuntime.jsx("button", { className: "btn-close btn-close-white me-2 m-auto", ref: refCloseButton })
  ] });
};
const defaultConfig = {
...
const Toast = React.forwardRef(function Toast2(props, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: !state.hidden && /* @__PURE__ */ jsxRuntime.jsx("div", { className: \`toast \${state.dismissible ? "toast-dismissible" : ""} \${!state.slotHeader ? "d-flex" : ""}\`, ref: refToast, children: /* @__PURE__ */ jsxRuntime.jsx(slot.Slot, { slotContent: state.slotStructure, props: slotContext }) }) });
});
exports.Toast = Toast;
`;export{t as default};
