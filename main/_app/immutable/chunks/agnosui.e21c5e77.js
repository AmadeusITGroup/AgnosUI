const a=`.au-slider {
  ...
  --au-slider-vertical-margin-block: 3rem;
  ...
  --au-slider-label-vertical-transform: translateY(-40%);
...
.au-slider.au-slider-vertical {
  ...
  margin-block: var(--au-slider-vertical-margin-block);
}
...
.au-slider .au-slider-label-vertical {
  ...
  transform: var(--au-slider-label-vertical-transform);
