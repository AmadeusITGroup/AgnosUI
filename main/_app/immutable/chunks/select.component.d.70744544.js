const e=`import type { ItemContext, SelectItemContext, SelectWidget, SlotContent, WidgetState, floatingUI } from '@agnos-ui/angular-headless';
...
export declare class SelectComponent<Item> implements OnChanges, AfterContentChecked {
     ...
     */
    allowedPlacements: floatingUI.Placement[] | undefined;
    /**
    ...
    readonly menuDirective: import("@agnos-ui/angular-headless").Directive<void>;
