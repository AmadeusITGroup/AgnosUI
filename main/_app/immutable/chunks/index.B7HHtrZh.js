...
const alert = require("./alert-CCoNpODI.cjs");
const modal = require("./modal-CTPEoJPj.cjs");
const pagination = require("./pagination-BV1nUAN9.cjs");
const progressbar = require("./progressbar-BKhdWkEy.cjs");
const rating = require("./rating-BXo-o1Wb.cjs");
const select = require("./select-Bho4Ftmi.cjs");
