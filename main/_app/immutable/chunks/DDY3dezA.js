...
class ModalDefaultSlotsComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ModalDefaultSlotsComponent, selectors: [["ng-component"]], viewQuery: function ModalDefaultSlotsComponent_Query(rf, ctx) { if (rf & 1) {
            i0.ɵɵviewQuerySignal(ctx.header, _c0$b, 5)(ctx.structure, _c1$b, 5);
        } if (rf & 2) {
            i0.ɵɵqueryAdvance(2);
...
class ModalComponent extends BaseWidgetDirective {
    constructor() {
        ...
        this.slotStructureFromContent = contentChild(ModalStructureDirective, ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        /**
        ...
        this.slotHeaderFromContent = contentChild(ModalHeaderDirective, ...(ngDevMode ? [{ debugName: "slotHeaderFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Title of the modal.
         */
        this.title = input(undefined, { ...(ngDevMode ? { debugName: "title" } : /* istanbul ignore next */ {}), alias: 'auTitle' });
        this.slotTitleFromContent = contentChild(ModalTitleDirective, ...(ngDevMode ? [{ debugName: "slotTitleFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Body of the modal.
         */
        this.children = input(undefined, { ...(ngDevMode ? { debugName: "children" } : /* istanbul ignore next */ {}), alias: 'auChildren' });
        this.slotDefaultFromContent = contentChild(ModalBodyDirective, ...(ngDevMode ? [{ debugName: "slotDefaultFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Footer of the modal.
         */
        this.footer = input(undefined, { ...(ngDevMode ? { debugName: "footer" } : /* istanbul ignore next */ {}), alias: 'auFooter' });
        this.slotFooterFromContent = contentChild(ModalFooterDirective, ...(ngDevMode ? [{ debugName: "slotFooterFromContent" }] : /* istanbul ignore next */ []));
        /**
        ...
        this.slotChildren = viewChild('content', ...(ngDevMode ? [{ debugName: "slotChildren" }] : /* istanbul ignore next */ []));
    }
...
function PaginationDefaultSlotsComponent_ng_template_0_For_1_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const api_r3 = ctx_r0.api;
    const directives_r4 = ctx_r0.directives;
    i0.ɵɵproperty("auUse", i0.ɵɵpureFunction2(6, _c4$8, directives_r4.pageLink, i0.ɵɵpureFunction1(4, _c3$8, page_r5)));
    i0.ɵɵadvance();
...
class PaginationDefaultSlotsComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: PaginationDefaultSlotsComponent, selectors: [["ng-component"]], viewQuery: function PaginationDefaultSlotsComponent_Query(rf, ctx) { if (rf & 1) {
            i0.ɵɵviewQuerySignal(ctx.pages, _c0$a, 5)(ctx.structure, _c1$a, 5);
        } if (rf & 2) {
            i0.ɵɵqueryAdvance(2);
...
class PaginationComponent extends BaseWidgetDirective {
    constructor() {
        ...
        this.slotEllipsisFromContent = contentChild(PaginationEllipsisDirective, ...(ngDevMode ? [{ debugName: "slotEllipsisFromContent" }] : /* istanbul ignore next */ []));
        /**
        ...
        this.slotFirstFromContent = contentChild(PaginationFirstDirective, ...(ngDevMode ? [{ debugName: "slotFirstFromContent" }] : /* istanbul ignore next */ []));
        /**
        ...
        this.slotPreviousFromContent = contentChild(PaginationPreviousDirective, ...(ngDevMode ? [{ debugName: "slotPreviousFromContent" }] : /* istanbul ignore next */ []));
        /**
        ...
        this.slotNextFromContent = contentChild(PaginationNextDirective, ...(ngDevMode ? [{ debugName: "slotNextFromContent" }] : /* istanbul ignore next */ []));
        /**
        ...
        this.slotLastFromContent = contentChild(PaginationLastDirective, ...(ngDevMode ? [{ debugName: "slotLastFromContent" }] : /* istanbul ignore next */ []));
        /**
        ...
        this.slotPagesFromContent = contentChild(PaginationPagesDirective, ...(ngDevMode ? [{ debugName: "slotPagesFromContent" }] : /* istanbul ignore next */ []));
        /**
        ...
        this.slotNumberLabelFromContent = contentChild(PaginationNumberDirective, ...(ngDevMode ? [{ debugName: "slotNumberLabelFromContent" }] : /* istanbul ignore next */ []));
        /**
         ...
         */
        this.structure = input(undefined, { ...(ngDevMode ? { debugName: "structure" } : /* istanbul ignore next */ {}), alias: 'auStructure' });
        this.slotStructureFromContent = contentChild(PaginationStructureDirective, ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        /**
...
class RatingComponent extends BaseWidgetDirective {
    ...
    constructor() {
        ...
        this.slotStarFromContent = contentChild(RatingStarDirective, ...(ngDevMode ? [{ debugName: "slotStarFromContent" }] : /* istanbul ignore next */ []));
        /**
...
class AlertComponent extends BaseWidgetDirective {
    constructor() {
         ...
         */
        this.children = input(undefined, { ...(ngDevMode ? { debugName: "children" } : /* istanbul ignore next */ {}), alias: 'auChildren' });
        this.slotDefaultFromContent = contentChild(AlertBodyDirective, ...(ngDevMode ? [{ debugName: "slotDefaultFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Global template for the alert component
         */
        this.structure = input(undefined, { ...(ngDevMode ? { debugName: "structure" } : /* istanbul ignore next */ {}), alias: 'auStructure' });
        this.slotStructureFromContent = contentChild(AlertStructureDirective, ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        /**
...
class AccordionItemComponent extends BaseWidgetDirective {
    constructor() {
         ...
         */
        this.header = input(undefined, { ...(ngDevMode ? { debugName: "header" } : /* istanbul ignore next */ {}), alias: 'auHeader' });
        this.slotHeaderFromContent = contentChild(AccordionHeaderDirective, ...(ngDevMode ? [{ debugName: "slotHeaderFromContent" }] : /* istanbul ignore next */ []));
        /**
         ...
         */
        this.children = input(undefined, { ...(ngDevMode ? { debugName: "children" } : /* istanbul ignore next */ {}), alias: 'auChildren' });
        this.slotBodyFromContent = contentChild(AccordionBodyDirective, ...(ngDevMode ? [{ debugName: "slotBodyFromContent" }] : /* istanbul ignore next */ []));
        /**
         ...
         */
        this.structure = input(undefined, { ...(ngDevMode ? { debugName: "structure" } : /* istanbul ignore next */ {}), alias: 'auStructure' });
        this.slotStructureFromContent = contentChild(AccordionItemStructureDirective, ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        /**
...
class SliderComponent extends BaseWidgetDirective {
    constructor() {
        ...
        this.slotLabelFromContent = contentChild(SliderLabelDirective, ...(ngDevMode ? [{ debugName: "slotLabelFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Slot to change the default display of the slider
         */
        this.structure = input(undefined, { ...(ngDevMode ? { debugName: "structure" } : /* istanbul ignore next */ {}), alias: 'auStructure' });
        this.slotStructureFromContent = contentChild(SliderStructureDirective, ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Slot to change the handlers
         */
        this.handle = input(undefined, { ...(ngDevMode ? { debugName: "handle" } : /* istanbul ignore next */ {}), alias: 'auHandle' });
        this.slotHandleFromContent = contentChild(SliderHandleDirective, ...(ngDevMode ? [{ debugName: "slotHandleFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Slot to change the ticks
         */
        this.tick = input(undefined, { ...(ngDevMode ? { debugName: "tick" } : /* istanbul ignore next */ {}), alias: 'auTick' });
        this.slotTickFromContent = contentChild(SliderTickDirective, ...(ngDevMode ? [{ debugName: "slotTickFromContent" }] : /* istanbul ignore next */ []));
        /**
...
class ProgressbarComponent extends BaseWidgetDirective {
    constructor() {
         ...
         */
        this.children = input(undefined, { ...(ngDevMode ? { debugName: "children" } : /* istanbul ignore next */ {}), alias: 'auChildren' });
        this.slotDefaultFromContent = contentChild(ProgressbarBodyDirective, ...(ngDevMode ? [{ debugName: "slotDefaultFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Global template for the Progressbar.
         */
        this.structure = input(undefined, { ...(ngDevMode ? { debugName: "structure" } : /* istanbul ignore next */ {}), alias: 'auStructure' });
        this.slotStructureFromContent = contentChild(ProgressbarStructureDirective, ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        /**
...
class ToastComponent extends BaseWidgetDirective {
    constructor() {
         ...
         */
        this.children = input(undefined, { ...(ngDevMode ? { debugName: "children" } : /* istanbul ignore next */ {}), alias: 'auChildren' });
        this.slotDefaultFromContent = contentChild(ToastBodyDirective, ...(ngDevMode ? [{ debugName: "slotDefaultFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Global template for the toast component
         */
        this.structure = input(undefined, { ...(ngDevMode ? { debugName: "structure" } : /* istanbul ignore next */ {}), alias: 'auStructure' });
        this.slotStructureFromContent = contentChild(ToastStructureDirective, ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Header template for the toast component
         */
        this.header = input(undefined, { ...(ngDevMode ? { debugName: "header" } : /* istanbul ignore next */ {}), alias: 'auHeader' });
        this.slotHeaderFromContent = contentChild(ToastHeaderDirective, ...(ngDevMode ? [{ debugName: "slotHeaderFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Callback called when the alert visibility changed.
         *
         * @defaultValue
...
class CollapseTriggerDirective {
    constructor() {
        this.auCollapseTrigger = input.required(...(ngDevMode ? [{ debugName: "auCollapseTrigger" }] : /* istanbul ignore next */ []));
...
class TreeComponent extends BaseWidgetDirective {
    constructor() {
        ...
        this.slotItemContentFromContent = contentChild(TreeItemContentDirective, ...(ngDevMode ? [{ debugName: "slotItemContentFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Slot to change the default display of the tree
         */
        this.structure = input(undefined, { ...(ngDevMode ? { debugName: "structure" } : /* istanbul ignore next */ {}), alias: 'auStructure' });
        this.slotStructureFromContent = contentChild(TreeStructureDirective, ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Slot to change the default tree item toggle
         */
        this.itemToggle = input(undefined, { ...(ngDevMode ? { debugName: "itemToggle" } : /* istanbul ignore next */ {}), alias: 'auItemToggle' });
        this.slotItemToggleFromContent = contentChild(TreeItemToggleDirective, ...(ngDevMode ? [{ debugName: "slotItemToggleFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Slot to change the default tree item
         */
        this.item = input(undefined, { ...(ngDevMode ? { debugName: "item" } : /* istanbul ignore next */ {}), alias: 'auItem' });
        this.slotItemFromContent = contentChild(TreeItemDirective, ...(ngDevMode ? [{ debugName: "slotItemFromContent" }] : /* istanbul ignore next */ []));
    }
...
class CarouselComponent extends BaseWidgetDirective {
    constructor() {
        ...
        this.slotSlideFromContent = contentChild((CarouselSlideDirective), ...(ngDevMode ? [{ debugName: "slotSlideFromContent" }] : /* istanbul ignore next */ []));
        this.slotStructureFromContent = contentChild((CarouselStructureDirective), ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        this.slotNavigationFromContent = contentChild((CarouselNavigationDirective), ...(ngDevMode ? [{ debugName: "slotNavigationFromContent" }] : /* istanbul ignore next */ []));
    }
...
class ToasterComponent {
    constructor() {
        ...
        this.auDismissible = input(this.toasterService.options().dismissible, ...(ngDevMode ? [{ debugName: "auDismissible" }] : /* istanbul ignore next */ []));
        this.auDuration = input(this.toasterService.options().duration, ...(ngDevMode ? [{ debugName: "auDuration" }] : /* istanbul ignore next */ []));
        this.auPosition = input(this.toasterService.options().position, ...(ngDevMode ? [{ debugName: "auPosition" }] : /* istanbul ignore next */ []));
        this.auLimit = input(this.toasterService.options().limit, ...(ngDevMode ? [{ debugName: "auLimit" }] : /* istanbul ignore next */ []));
        this.auPauseOnHover = input(this.toasterService.options().pauseOnHover, ...(ngDevMode ? [{ debugName: "auPauseOnHover" }] : /* istanbul ignore next */ []));
        this.auCloseAll = input(this.toasterService.options().closeAll, ...(ngDevMode ? [{ debugName: "auCloseAll" }] : /* istanbul ignore next */ []));
        this.auCloseAllLabel = input(this.toasterService.options().closeAllLabel, ...(ngDevMode ? [{ debugName: "auCloseAllLabel" }] : /* istanbul ignore next */ []));
        this.positionClass = computed(() => export_toastPositions[this.toasterService.options().position], ...(ngDevMode ? [{ debugName: "positionClass" }] : /* istanbul ignore next */ []));
        effect(() => {
...
class DrawerComponent extends BaseWidgetDirective {
    constructor() {
         ...
         */
        this.structure = input(undefined, { ...(ngDevMode ? { debugName: "structure" } : /* istanbul ignore next */ {}), alias: 'auStructure' });
        this.slotStructureFromContent = contentChild(DrawerStructureDirective, ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Template for the drawer header
         */
        this.header = input(undefined, { ...(ngDevMode ? { debugName: "header" } : /* istanbul ignore next */ {}), alias: 'auHeader' });
        this.slotHeaderFromContent = contentChild(DrawerHeaderDirective, ...(ngDevMode ? [{ debugName: "slotHeaderFromContent" }] : /* istanbul ignore next */ []));
        /**
         * Template for the drawer body
         */
        this.children = input(undefined, { ...(ngDevMode ? { debugName: "children" } : /* istanbul ignore next */ {}), alias: 'auChildren' });
        this.slotBodyFromContent = contentChild(DrawerBodyDirective, ...(ngDevMode ? [{ debugName: "slotBodyFromContent" }] : /* istanbul ignore next */ []));
        this.slotChildren = viewChild('content', ...(ngDevMode ? [{ debugName: "slotChildren" }] : /* istanbul ignore next */ []));
    }
