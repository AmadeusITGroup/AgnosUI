...
import { c as addEvent, d as bindAttribute, e as bindStyle, f as bindClassName } from "../dom-CE6hri87.js";
import { n as noop } from "../func-DR0n-ShK.js";
import { toReadableStore } from "./stores.js";
...
const createAttributesDirective = (propsFn) => (node, args) => {
  ...
  for (const [type, eventFn] of Object.entries(events ?? {})) {
    unsubscribers.push(addEvent(node, type, eventFn));
  }
