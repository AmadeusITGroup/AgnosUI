const a=`--#{variables.$prefix}slider-background-color: #{variables.$au-slider-color-background};
...
--#{variables.$prefix}slider-disabled-cursor: #{variables.$au-slider-disabled-cursor};`;export{a as default};
