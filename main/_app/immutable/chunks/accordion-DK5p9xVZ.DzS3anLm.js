...
const ItemContent = (slotContext) => /* @__PURE__ */ jsx("div", { className: "accordion-collapse", ...useDirective(slotContext.widget.directives.bodyContainerDirective), children: /* @__PURE__ */ jsx("div", { className: "accordion-body", ...useDirective(slotContext.widget.directives.bodyDirective), children: /* @__PURE__ */ jsx(Slot, { slotContent: slotContext.state.slotItemBody, props: slotContext }) }) });
