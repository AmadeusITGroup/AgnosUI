...
function createModal(config$) {
  ...
  const res = {
    ...
    directives: {
      ...
      modalDirective: utils_directive.mergeDirectives(modalTransition.directives.directive, services_siblingsInert.sliblingsInert, utils_directive.directiveSubscribe(action$), modalAttributeDirective),
