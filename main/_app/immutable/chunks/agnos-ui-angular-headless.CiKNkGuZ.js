const n=`export * from '@agnos-ui/core/services/siblingsInert';
...
import { Directive, Input, inject, NgZone, Injectable, signal, DestroyRef, Injector, runInInjectionContext, SkipSelf, Optional, InjectionToken, ElementRef, PLATFORM_ID, afterNextRender, booleanAttribute, numberAttribute, Component, ViewChild, createComponent, EnvironmentInjector, TemplateRef, reflectComponentType, ViewContainerRef } from '@angular/core';
