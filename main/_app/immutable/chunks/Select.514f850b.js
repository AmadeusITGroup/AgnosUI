...
function Badges({ slotContext }) {
    ...
    for (const itemContext of slotContext.state.selectedContexts) {
        badges.push(_jsx("div", { className: \`au-select-badge me-1 \${state.badgeClassName}\`, children: _jsx(Slot, { slotContent: state.slotBadgeLabel, props: { ...slotContext, itemContext } }) }));
    }
