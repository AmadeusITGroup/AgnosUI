...
.au-slider {
  ...
  --bs-slider-margin-block-start: calc((var(--bs-slider-handle-size) - var(--bs-slider-secondary-size)) / 2 + var(--bs-slider-font-size) * 1.5 + 0.5rem);
  --bs-slider-margin-block-end: calc((var(--bs-slider-handle-size) - var(--bs-slider-secondary-size)) / 2 + 0.5rem);
