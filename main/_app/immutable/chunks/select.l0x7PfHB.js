...
export function Select(props) {
    ...
    return (_jsxs("div", { ref: refSetContainer, className: \`au-select dropdown border border-1 p-1 mb-3 d-block \${className}\`, children: [_jsxs("div", { ref: refSetInputContainer, role: "combobox", className: "d-flex align-items-center flex-wrap", "aria-haspopup": "listbox", "aria-expanded": open, children: [_jsx(Badges, { slotContext: slotContext }), _jsx("input", { id: id, "aria-label": ariaLabel, className: "au-select-input flex-grow-1 border-0", type: "text", value: filterText, "aria-autocomplete": "list", autoCorrect: "off", autoCapitalize: "none", autoComplete: "off", onInput: widget.actions.onInput, onKeyDown: (e) => widget.actions.onInputKeydown(e.nativeEvent) })] }), open && visibleItems.length > 0 && (_jsx("ul", { ref: refSetMenu, className: \`dropdown-menu show \${menuClassName}\`, "data-popper-placement": placement, onMouseDown: preventDefault, children: _jsx(Rows, { slotContext: slotContext }) }))] }));
}
`;export{e as default};
