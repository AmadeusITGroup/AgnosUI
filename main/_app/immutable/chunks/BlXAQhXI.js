...
import { Widget, SlotContent, Directive, WidgetFactory, BaseWidgetDirective, WidgetSlotContext, TransitionFn, PropsConfig, ConfigValidator, ToasterService as ToasterService$1, WidgetProps, AngularWidget, IsSlotContent, Partial2Levels, WidgetsConfigStore } from '@agnos-ui/angular-headless';
export * from '@agnos-ui/angular-headless';
import * as _angular_core from '@angular/core';
import { TemplateRef, AfterViewInit, OnInit, InputSignal, Injector, FactoryProvider, InjectionToken } from '@angular/core';
import { ControlValueAccessor } from '@angular/forms';
import { modalCloseButtonClick, modalCloseEscape, modalOutsideClick } from '@agnos-ui/core-bootstrap/components/modal';
...
declare class AlertBodyDirective {
    templateRef: TemplateRef<any>;
    static ngTemplateContextGuard(_dir: AlertBodyDirective, _context: unknown): _context is AlertContext;
...
declare class AlertStructureDirective {
    templateRef: TemplateRef<any>;
    static ngTemplateContextGuard(_dir: AlertStructureDirective, _context: unknown): _context is AlertContext;
...
declare class CarouselStructureDirective<SlideData extends {
    ...
    static ngTemplateContextGuard<SlideData extends {
        id: string;
    }>(_dir: CarouselStructureDirective<SlideData>, _context: unknown): _context is CarouselContext<SlideData>;
...
declare class CarouselNavigationDirective<SlideData extends {
    ...
    static ngTemplateContextGuard<SlideData extends {
        id: string;
    }>(_dir: CarouselNavigationDirective<SlideData>, _context: unknown): _context is CarouselContext<SlideData>;
...
declare class CarouselSlideDirective<SlideData extends {
    ...
    static ngTemplateContextGuard<SlideData extends {
        id: string;
    }>(_dir: CarouselSlideDirective<SlideData>, _context: unknown): _context is CarouselSlideContext<SlideData>;
