...
const DefaultSlotStructure = (slotContext) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    slotContext.state.slotHeader && /* @__PURE__ */ jsxs("div", { className: "toast-header", children: [
      ...
      slotContext.state.dismissible && /* @__PURE__ */ jsx("button", { className: "btn-close me-0 ms-auto", ref: refCloseButton })
    ] }),
    ...
    slotContext.state.dismissible && !slotContext.state.slotHeader && /* @__PURE__ */ jsx("button", { className: "btn-close btn-close-white me-2 m-auto", ref: refCloseButton })
  ] });
};
const defaultConfig = {
...
const Toast = forwardRef(function Toast2(props, ref) {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: !state.hidden && /* @__PURE__ */ jsx("div", { className: \`toast \${state.dismissible ? "toast-dismissible" : ""} \${!state.slotHeader ? "d-flex" : ""}\`, ref: refToast, children: /* @__PURE__ */ jsx(Slot, { slotContent: state.slotStructure, props: slotContext }) }) });
});
export {
  Toast as T
};
