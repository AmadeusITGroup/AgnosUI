...
const BackdropElement = ({ widget }) => /* @__PURE__ */ jsxRuntime.jsx("div", { className: "modal-backdrop", ...directive.useDirective(widget.directives.backdropDirective) });
const ModalElement = (slotContext) => /* @__PURE__ */ jsxRuntime.jsx("div", { className: "modal d-block", ...directive.useDirective(slotContext.widget.directives.modalDirective), children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "modal-dialog", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "modal-content", children: /* @__PURE__ */ jsxRuntime.jsx(slot.Slot, { slotContent: slotContext.state.slotStructure, props: slotContext }) }) }) });
