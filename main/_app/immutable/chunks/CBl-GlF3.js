...
class SlotComponent {
    constructor() {
         ...
         */
        this.state = input.required(...(ngDevMode ? [{ debugName: "state" }] : /* istanbul ignore next */ []));
        /**
         * all the api functions to interact with the widget
         */
        this.api = input.required(...(ngDevMode ? [{ debugName: "api" }] : /* istanbul ignore next */ []));
        /**
         * directives to be used on html elements in the template of the slot
         */
        this.directives = input.required(...(ngDevMode ? [{ debugName: "directives" }] : /* istanbul ignore next */ []));
        /**
         * The slot context, to be used when the slot component uses other slots.
         */
        this.slotContext = computed$1(() => ({ state: this.state(), api: this.api(), directives: this.directives() }), ...(ngDevMode ? [{ debugName: "slotContext" }] : /* istanbul ignore next */ []));
    }
