 ...
 */
export declare const SliderDefaultSlotHandle: (slotContext: SliderSlotHandleContext) => React.JSX.Element;
/**
 ...
 */
export declare const SliderDefaultTick: (slotContext: SliderSlotTickContext) => React.JSX.Element;
/**
 ...
 *
 */
export declare const SliderDefaultSlotStructure: (slotContext: SliderContext) => React.JSX.Element;
/**
 ...
 */
export declare function Slider(props: PropsWithChildren<Partial<SliderProps>>): React.JSX.Element;
`;export{e as default};
