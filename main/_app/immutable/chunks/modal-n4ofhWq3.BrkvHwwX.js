...
const Modal = forwardRef(function Modal2(props, ref) {
  ...
  return /* @__PURE__ */ jsxs(Portal, { container: state.container, children: [
    state.backdropHidden ? null : /* @__PURE__ */ jsx("div", { className: \`modal-backdrop \${state.backdropClass}\`, ...refSetBackdrop }),
    state.hidden ? null : /* @__PURE__ */ jsx("div", { className: \`modal d-block \${state.className}\`, onClick: widget.actions.modalClick, ...refSetModal, children: /* @__PURE__ */ jsx("div", { className: "modal-dialog", children: /* @__PURE__ */ jsx("div", { className: "modal-content", children: /* @__PURE__ */ jsx(Slot, { slotContent: state.slotStructure, props: slotContext }) }) }) })
  ] });
});
