 ...
 */
export declare const DefaultTreeSlotItemToggle: (slotContext: TreeSlotItemContext) => import("react").JSX.Element;
/**
 ...
 */
export declare const DefaultTreeSlotItemContent: (slotContext: TreeSlotItemContext) => import("react").JSX.Element;
/**
 ...
 */
export declare const DefaultTreeSlotItem: (slotContext: TreeSlotItemContext) => import("react").JSX.Element;
/**
 ...
 */
export declare const DefaultTreeSlotStructure: (slotContext: TreeContext) => import("react").JSX.Element;
/**
 ...
 */
export declare function Tree(props: Partial<TreeProps>): import("react").JSX.Element;
`;export{e as default};
