...
const BackdropElement = ({ widget }) => /* @__PURE__ */ jsx("div", { className: "modal-backdrop", ...useDirective(widget.directives.backdropDirective) });
const ModalElement = (slotContext) => /* @__PURE__ */ jsx("div", { className: "modal d-block", ...useDirective(slotContext.widget.directives.modalDirective), children: /* @__PURE__ */ jsx("div", { className: "modal-dialog", children: /* @__PURE__ */ jsx("div", { className: "modal-content", children: /* @__PURE__ */ jsx(Slot, { slotContent: slotContext.state.slotStructure, props: slotContext }) }) }) });
