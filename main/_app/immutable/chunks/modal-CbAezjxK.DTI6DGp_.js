...
import { useDirectives, useClassDirective, useDirective } from "@agnos-ui/react-headless/utils/directive";
...
const BackdropElement = ({ widget }) => /* @__PURE__ */ jsx("div", { ...useDirectives([useClassDirective("modal-backdrop"), widget.directives.backdropDirective]) });
const ModalElement = (slotContext) => /* @__PURE__ */ jsx("div", { ...useDirectives([useClassDirective("modal d-block"), slotContext.widget.directives.modalDirective]), children: /* @__PURE__ */ jsx("div", { className: "modal-dialog", children: /* @__PURE__ */ jsx("div", { className: "modal-content", children: /* @__PURE__ */ jsx(Slot, { slotContent: slotContext.state.slotStructure, props: slotContext }) }) }) });
