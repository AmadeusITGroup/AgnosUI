...
export declare const widgetsConfigFactory: <Config extends {
    ...
    callWidgetFactory: <W extends Widget<object, object, object, object, object>>(factory: WidgetFactory<W>, widgetName: keyof Config | null, slots: SlotsPresent<WidgetProps<W>>, defaultConfig?: Partial<WidgetProps<W>> | ReadableSignal<Partial<WidgetProps<W>>>) => W & {
...
export declare const widgetsDefaultConfigKey: symbol, createWidgetsDefaultConfig: (adaptParentConfig?: ((config: Partial<{
    ...
    accordion: Partial<AdaptPropsSlots<import("@agnos-ui/core").AccordionProps>>;
    progressbar: Partial<AdaptPropsSlots<import("@agnos-ui/core").ProgressbarProps>>;
}>) | undefined) => WidgetsConfigStore<WidgetsConfig>, getContextWidgetConfig: <N extends keyof CoreWidgetsConfig>(widgetName: N) => ReadableSignal<Partial<WidgetsConfig[N]> | undefined>, callWidgetFactory: <W extends Widget<object, object, object, object, object>>(factory: WidgetFactory<W>, widgetName: keyof CoreWidgetsConfig | null, slots: SlotsPresent<WidgetProps<W>>, defaultConfig?: Partial<WidgetProps<W>> | ReadableSignal<Partial<WidgetProps<W>>>) => W & {
    patchChangedProps: W["patch"];
};
`;export{o as default};
