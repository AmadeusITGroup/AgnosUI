...
.au-slider {
  --bs-slider-background-color: var(--bs-secondary-bg);
  ...
  --bs-slider-margin-block-start: 2rem;
  --bs-slider-margin-block-end: 1rem;
  ...
  --bs-slider-handle-color: var(--bs-primary);
  ...
  --bs-slider-progress-color: var(--bs-primary);
  ...
  --bs-slider-disabled-color: var(--bs-dark-bg-subtle);
...
.au-slider.au-slider-handle-horizontal.au-slider-label-now, .au-slider.au-slider-handle-vertical.au-slider-label-now {
  font-weight: --bs-slider-label-now-font-weight;
}
