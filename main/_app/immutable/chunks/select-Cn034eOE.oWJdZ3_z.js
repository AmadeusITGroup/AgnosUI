...
function Select(props) {
  const [state, widget] = generated_config.useWidgetWithConfig(select.createSelect, props, "select", defaultConfig);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: \`au-select dropdown border border-1 p-1 mb-3 d-block \${className}\`, ...directive.useDirective(referenceDirective), children: [
    /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...directive.useDirectives([hasFocusDirective, inputContainerDirective]),
        role: "combobox",
