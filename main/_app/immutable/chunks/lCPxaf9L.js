...
class TreeComponent extends BaseWidgetDirective {
    constructor() {
        ...
        this.slotItemContentFromContent = viewChild(TreeItemContentDirective, ...(ngDevMode ? [{ debugName: "slotItemContentFromContent" }] : []));
        /**
         * Slot to change the default display of the tree
         */
        this.structure = input(undefined, ...(ngDevMode ? [{ debugName: "structure", alias: 'auStructure' }] : [{ alias: 'auStructure' }]));
        this.slotStructureFromContent = viewChild(TreeStructureDirective, ...(ngDevMode ? [{ debugName: "slotStructureFromContent" }] : []));
        /**
         * Slot to change the default tree item toggle
         */
        this.itemToggle = input(undefined, ...(ngDevMode ? [{ debugName: "itemToggle", alias: 'auItemToggle' }] : [{ alias: 'auItemToggle' }]));
        this.slotItemToggleFromContent = viewChild(TreeItemToggleDirective, ...(ngDevMode ? [{ debugName: "slotItemToggleFromContent" }] : []));
        /**
         * Slot to change the default tree item
         */
        this.item = input(undefined, ...(ngDevMode ? [{ debugName: "item", alias: 'auItem' }] : [{ alias: 'auItem' }]));
        this.slotItemFromContent = viewChild(TreeItemDirective, ...(ngDevMode ? [{ debugName: "slotItemFromContent" }] : []));
    }
