...
function createAccordionItem(accordionOnShown, accordionOnHidden, config) {
  ...
  return {
    ...
    directives: {
      ...
      headerDirective: utils_directive.createAttributesDirective(() => ({ attributes: { class: itemHeaderClass$() }, classNames: { "au-accordion-item-header": true } })),
      bodyDirective: utils_directive.createAttributesDirective(() => ({ attributes: { class: itemBodyClass$() }, classNames: { "au-accordion-item-body": true } })),
