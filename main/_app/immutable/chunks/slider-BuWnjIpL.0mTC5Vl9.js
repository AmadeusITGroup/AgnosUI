...
function createSlider(config) {
  ...
  const { directive: minLabelDirective, element$: minLabelDom$ } = utils_directive.createStoreDirective();
  const { directive: maxLabelDirective, element$: maxLabelDom$ } = utils_directive.createStoreDirective();
