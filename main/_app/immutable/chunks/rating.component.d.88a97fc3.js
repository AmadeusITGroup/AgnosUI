const e=`import type { StarContext, WidgetProps, WidgetState } from '@agnos-ui/core';
...
export declare class RatingComponent implements ControlValueAccessor, OnChanges, AfterContentChecked {
    readonly _widget: import("../slot.directive").WithPatchSlots<import("@agnos-ui/core").RatingWidget>;
    readonly api: object;
