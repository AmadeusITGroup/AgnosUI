...
class DrawerComponent extends BaseWidgetDirective {
    constructor() {
         ...
         * @defaultValue \`200\`
         */
        this.width = input(undefined, { ...(ngDevMode ? { debugName: "width" } : {}), alias: 'auWidth', transform: auNumberAttribute });
        /**
         * The height of the drawer in pixels.
         *
         * @defaultValue \`200\`
         */
        this.height = input(undefined, { ...(ngDevMode ? { debugName: "height" } : {}), alias: 'auHeight', transform: auNumberAttribute });
        /**
