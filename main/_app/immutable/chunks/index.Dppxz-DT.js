...
const accordion = require("./accordion-BFFfMpqg.cjs");
const alert = require("./alert-DemTb5LV.cjs");
const modal = require("./modal-BI1PSPTI.cjs");
...
const select = require("./select-sYf_JrU-.cjs");
const slider = require("./slider-tt0fqOVJ.cjs");
const toast = require("./toast-DReV5dGs.cjs");
