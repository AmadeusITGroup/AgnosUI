...
export function Slider(props) {
    ...
    return (_jsxs("div", { ref: sliderSetRef, className: \`au-slider \${vertical ? 'au-slider-vertical' : 'au-slider-horizontal'} \${className} \${disabled ? ' disabled' : ''}\`, "aria-disabled": disabled ? 'true' : undefined, children: [progressDisplayOptions.map((option, index) => (_jsx("div", { className: 'au-slider-progress', style: {
                    left: \`\${option.left}%\`,
                    right: \`\${option.right}%\`,
