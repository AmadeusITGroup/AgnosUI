const e=`import { toReadableStore, toSlotContextWidget, createWidgetsConfig, createAccordion as createAccordion$1, createAlert as createAlert$1, createModal as createModal$1, createPagination as createPagination$1, createRating as createRating$1, createSelect as createSelect$1, createProgressbar as createProgressbar$1 } from '@agnos-ui/core';
export * from '@agnos-ui/core';
import { writable, computed } from '@amadeus-it-group/tansu';
import * as i0 from '@angular/core';
import { NgZone, inject, Injectable, signal, DestroyRef, Directive, Injector, runInInjectionContext, SkipSelf, Optional, InjectionToken, Input, EnvironmentInjector, createComponent, TemplateRef, reflectComponentType, ViewContainerRef, ElementRef, booleanAttribute, numberAttribute } from '@angular/core';
