...
export declare class AccordionItemComponent extends BaseWidgetDirective<AccordionItemWidget> implements AfterContentChecked, AfterViewInit {
    ...
    readonly _widget: import("@agnos-ui/angular-headless").AngularWidget<import("@agnos-ui/angular-headless").AdaptWidgetSlots<import("core/dist/components/accordion/accordion").AccordionItemWidget>>;
    constructor();
