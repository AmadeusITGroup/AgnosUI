 ...
 */
export declare const attributesData: <T extends any[]>(...directives: { [K in keyof T]: DirectiveAndParam<T[K]> | Directive<void>; }) => {
 ...
 */
export declare function createClassDirective(className: string): Directive<void>;
/**
