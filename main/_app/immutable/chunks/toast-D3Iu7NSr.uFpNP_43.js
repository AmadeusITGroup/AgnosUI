...
const ToastHeader = (slotContext) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "toast-header", children: [
  ...
  slotContext.state.dismissible && /* @__PURE__ */ jsxRuntime.jsx("button", { className: "btn-close me-0 ms-auto", ...directive.useDirective(slotContext.widget.directives.closeButtonDirective) })
] });
const ToastCloseButtonNoHeader = (slotContext) => /* @__PURE__ */ jsxRuntime.jsx("button", { className: "btn-close btn-close-white me-2 m-auto", ...directive.useDirective(slotContext.widget.directives.closeButtonDirective) });
