...
export const PageItem = React.forwardRef(({ disabled, active, ariaLabel, activeLabel, className, children, ...props }, ref) => {
    return (_jsx("li", { ref: ref, "aria-current": active ? 'page' : undefined, className: classNames('page-item', { active, disabled }), children: _jsxs("a", { className: classNames('page-link', className), "aria-label": ariaLabel || undefined, ...props, href: '#', tabIndex: disabled ? -1 : undefined, "aria-disabled": disabled || undefined, children: [children, active && activeLabel && _jsx("span", { className: "visually-hidden", children: activeLabel })] }) }));
});
