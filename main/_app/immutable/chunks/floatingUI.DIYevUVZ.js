...
const createFloatingUI = (propsConfig) => {
  ...
  const { directive: floatingDirective, element$: floatingElement$ } = utils_directive.createStoreDirective();
  const { directive: referenceDirective, element$: referenceElement$ } = utils_directive.createStoreDirective();
  const { directive: arrowDirective, element$: arrowElement$ } = utils_directive.createStoreDirective();
