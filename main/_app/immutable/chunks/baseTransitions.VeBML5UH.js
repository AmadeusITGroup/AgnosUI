...
import { h as createStoreDirective, k as mergeDirectives, d as directiveSubscribe, e as directiveUpdate } from "../../directive-CKEccryv.js";
...
const createTransition = (config) => {
  ...
  const directive = mergeDirectives(
    storeDirective,
    directiveUpdate((args) => {
      if (args) {
        patch(args);
      }
    }),
