const n=`const equal = (a, b) => Object.is(a, b) && (!a || typeof a !== "object") && typeof a !== "function";
...
class RawStoreConst {
  ...
  subscribe(subscriber) {
    ...
    if (typeof subscriber === "function") {
      ...
      (_a = subscriber == null ? void 0 : subscriber.next) == null ? void 0 : _a.call(subscriber, this.value);
    }
    return noopUnsubscribe;
  }
}
...
function readable(value, options) {
  return exposeRawStore(new RawStoreConst(value));
}
