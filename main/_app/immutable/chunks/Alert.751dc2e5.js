...
export const Alert = forwardRef(function Alert(props, ref) {
    ...
    return (_jsx(_Fragment, { children: state.hidden ? null : (_jsx("div", { className: \`au-alert alert alert-\${state.type} \${state.className}\`, role: "alert", ref: refTransition, children: _jsx(Slot, { slotContent: state.slotStructure, props: slotContext }) })) }));
});
`;export{t as default};
