import{a as g,t as x,c as ae}from"../chunks/disclose-version.BGQ9DrdY.js";import{p as J,l as w,b as re,f as S,t as j,a as P,d as u,g as e,s as a,m as h,c as t,r as n,R as se,J as W}from"../chunks/runtime.BEOU7zaz.js";import{s as oe}from"../chunks/Code.C9-E52J8.js";import{i as B}from"../chunks/lifecycle.BQIQNVl9.js";import{p as $}from"../chunks/props.BddUafVw.js";import{H as ie}from"../chunks/Header.Ch2pc11G.js";import{s as D,e as le}from"../chunks/render.CJU4SkFP.js";import{i as H}from"../chunks/if.imcvzz0d.js";import{s as b}from"../chunks/stores.B-gqFnsy.js";import{s as ce,a as ue,p as he}from"../chunks/stores.D0r8cxzd.js";import{S as y}from"../chunks/logo-svelte.X03F6W0v.js";import{t as de}from"../chunks/twitter-x.DTs9qsur.js";import pe from"../chunks/fbasso.u0p32XiR.js";import{o as ge}from"../chunks/index-client.BoGQsvAy.js";import{M as me}from"../chunks/Markdown.e0xHR2Lj.js";const fe=`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
...
</svg>`;var be=x('<button class="nav-link" aria-label="Share blog post"><!></button>'),ye=x('<a target="_blank" class="nav-link" aria-label="Share on Twitter"><!></a> <a target="_blank" class="nav-link" aria-label="Share on Facebook"><!></a> <a target="_blank" class="nav-link" aria-label="Share on LinkedIn"><!></a>',1),Se=x('<div class="d-flex flex-wrap"><div class="d-flex gap-3"><img alt="Publisher avatar" class="avatar svelte-zj55sz" width="50" height="50"> <div><strong> </strong> <div> </div></div></div> <div class="d-flex flex-grow-1 justify-content-end gap-3 ms-5 align-self-end"><!></div></div> <hr>',1);function $e(k,r){J(r,!1);const m=ce(),s=()=>ue(he,"$page",m),o=h(),i=h(),d=h(),p=h(),L={fbasso:{icon:pe,title:"Fabrice Basso, Software engineer at Amadeus"}};let O=$(r,"date",8),R=$(r,"author",8),f=$(r,"title",8),T=h(!1),V=h(!1);ge(()=>{u(T,!!navigator.canShare?.(e(p))),u(V,!0)});const G=()=>{e(T)&&navigator.share(e(p))};w(()=>s(),()=>{u(o,encodeURIComponent(s().url.href))}),w(()=>W(f()),()=>{u(i,encodeURIComponent(f()))}),w(()=>W(O()),()=>{u(d,Intl.DateTimeFormat("en-US",{dateStyle:"medium"}).format(new Date(O())))}),w(()=>(s(),W(f())),()=>{u(p,{url:s().url.href,title:f()})}),re(),B();var E=Se(),F=S(E),I=t(F),M=t(I),z=a(M,2),_=t(z),Y=t(_);n(_);var N=a(_,2),K=t(N);n(N),n(z),n(I);var U=a(I,2),Q=t(U);H(Q,()=>e(V),X=>{var q=ae(),Z=S(q);H(Z,()=>e(T),A=>{var l=be(),c=t(l);y(c,{className:"icon-20 align-middle",svg:we}),n(l),le("click",l,G),g(A,l)},A=>{var l=ye(),c=S(l),ee=t(c);y(ee,{className:"icon-20 align-middle",svg:de}),n(c);var v=a(c,2),te=t(v);y(te,{className:"icon-20 align-middle",svg:fe}),n(v);var C=a(v,2),ne=t(C);y(ne,{className:"icon-20 align-middle",svg:ve}),n(C),j(()=>{b(c,"href",`https://twitter.com/share?url=${e(o)??""}&text=${e(i)??""}`),b(v,"href",`https://www.facebook.com/sharer/sharer.php?u=${e(o)??""}&p[title]=${e(i)??""}`),b(C,"href",`https://www.linkedin.com/shareArticle?mini=true&url=${e(o)??""}&title=${e(i)??""}`)}),g(A,l)}),g(X,q)}),n(U),n(F),se(2),j(()=>{b(M,"src",L[R()].icon),D(Y,L[R()].title),D(K,`Published on ${e(d)??""}`)}),g(k,E),P()}const xe=`In [AgnosUI](https://amadeusitgroup.github.io/AgnosUI/latest/), we employ [Tansu](https://github.com/AmadeusITGroup/tansu) to handle our component states.
...
`;var ke=x('<!> <!> <img src="https://amadeusitgroup.github.io/AgnosUI/static/tansu-blog.webp" alt="frontend development" class="mb-3" width="100%"> <!>',1);function Ue(k,r){J(r,!1);let m=$(r,"data",8);B();var s=ke(),o=S(s);ie(o,{get title(){return m().pageMeta.title}});var i=a(o,2);$e(i,{date:"02/01/2024",author:"fbasso",get title(){return m().pageMeta.title}});var d=a(i,2);oe(d,"aspect-ratio",1024/500);var p=a(d,2);me(p,{source:xe}),g(k,s),P()}export{Ue as component};
