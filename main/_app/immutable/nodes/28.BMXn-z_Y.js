import{s as I,e as A,t as T,c as W,b as L,d as k,f as c,m as $,i as d,h as S,j as R,n as x,a as p,v as C,g as m}from"../chunks/scheduler.BCoUmZgo.js";import{S as O,i as E,c as g,b as f,m as y,t as w,a as v,e as b}from"../chunks/index.Dun_Df-H.js";import{H as _}from"../chunks/Header.DsHRrwQZ.js";import{M as F}from"../chunks/Markdown.C3zZSoJD.js";function V(i){let t,r,n;return{c(){t=A("strong"),r=T("Published on "),n=T(i[0]),this.h()},l(a){t=W(a,"STRONG",{class:!0});var s=L(t);r=k(s,"Published on "),n=k(s,i[0]),s.forEach(c),this.h()},h(){$(t,"class","d-flex mb-2")},m(a,s){d(a,t,s),S(t,r),S(t,n)},p(a,[s]){s&1&&R(n,a[0])},i:x,o:x,d(a){a&&c(t)}}}function q(i,t,r){let{date:n}=t;return n=Intl.DateTimeFormat("en-US",{dateStyle:"full"}).format(new Date(n)),i.$$set=a=>{"date"in a&&r(0,n=a.date)},[n]}class M extends O{constructor(t){super(),E(this,t,q,V,I,{date:0})}}const N=`In [AgnosUI](https://amadeusitgroup.github.io/AgnosUI/latest/), we employ [Tansu](https://github.com/AmadeusITGroup/tansu) to handle our component states.
...
`;function U(i){let t,r,n,a,s,u,l,h;return n=new _({props:{title:"State management with Tansu"}}),s=new M({props:{date:"02/01/2024"}}),l=new F({props:{source:N}}),{c(){t=A("meta"),r=p(),g(n.$$.fragment),a=p(),g(s.$$.fragment),u=p(),g(l.$$.fragment),this.h()},l(e){const o=C("svelte-1jjkb5h",document.head);t=W(o,"META",{name:!0,content:!0}),o.forEach(c),r=m(e),f(n.$$.fragment,e),a=m(e),f(s.$$.fragment,e),u=m(e),f(l.$$.fragment,e),this.h()},h(){document.title="State management with Tansu",$(t,"name","description"),$(t,"content","Blog article exploring State Management with Tansu.")},m(e,o){S(document.head,t),d(e,r,o),y(n,e,o),d(e,a,o),y(s,e,o),d(e,u,o),y(l,e,o),h=!0},p:x,i(e){h||(w(n.$$.fragment,e),w(s.$$.fragment,e),w(l.$$.fragment,e),h=!0)},o(e){v(n.$$.fragment,e),v(s.$$.fragment,e),v(l.$$.fragment,e),h=!1},d(e){e&&(c(r),c(a),c(u)),c(t),b(n,e),b(s,e),b(l,e)}}}class D extends O{constructor(t){super(),E(this,t,null,U,I,{})}}export{D as component};
