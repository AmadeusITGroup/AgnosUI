import{s as x,e as I,t as w,c as A,b as W,d as v,f as c,m as O,i as f,h as b,j as L,n as y,a as $,g as S}from"../chunks/scheduler.CjdZHXTE.js";import{S as k,i as T,c as u,b as h,m as d,t as p,a as m,d as g}from"../chunks/index.LOJ-J52o.js";import{H as E}from"../chunks/Header.Bjs_GV-p.js";import{M as R}from"../chunks/Markdown.Ct1v0idS.js";function C(o){let t,r,n;return{c(){t=I("strong"),r=w("Published on "),n=w(o[0]),this.h()},l(a){t=A(a,"STRONG",{class:!0});var s=W(t);r=v(s,"Published on "),n=v(s,o[0]),s.forEach(c),this.h()},h(){O(t,"class","d-flex mb-2")},m(a,s){f(a,t,s),b(t,r),b(t,n)},p(a,[s]){s&1&&L(n,a[0])},i:y,o:y,d(a){a&&c(t)}}}function F(o,t,r){let{date:n}=t;return n=Intl.DateTimeFormat("en-US",{dateStyle:"full"}).format(new Date(n)),o.$$set=a=>{"date"in a&&r(0,n=a.date)},[n]}class _ extends k{constructor(t){super(),T(this,t,F,C,x,{date:0})}}const V=`In [AgnosUI](https://amadeusitgroup.github.io/AgnosUI/latest/), we employ [Tansu](https://github.com/AmadeusITGroup/tansu) to handle our widget states.
...
`;function q(o){let t,r,n,a,s,l;return t=new E({props:{title:"State management with Tansu"}}),n=new _({props:{date:"02/01/2024"}}),s=new R({props:{source:V}}),{c(){u(t.$$.fragment),r=$(),u(n.$$.fragment),a=$(),u(s.$$.fragment)},l(e){h(t.$$.fragment,e),r=S(e),h(n.$$.fragment,e),a=S(e),h(s.$$.fragment,e)},m(e,i){d(t,e,i),f(e,r,i),d(n,e,i),f(e,a,i),d(s,e,i),l=!0},p:y,i(e){l||(p(t.$$.fragment,e),p(n.$$.fragment,e),p(s.$$.fragment,e),l=!0)},o(e){m(t.$$.fragment,e),m(n.$$.fragment,e),m(s.$$.fragment,e),l=!1},d(e){e&&(c(r),c(a)),g(t,e),g(n,e),g(s,e)}}}class P extends k{constructor(t){super(),T(this,t,null,q,x,{})}}export{P as component};
