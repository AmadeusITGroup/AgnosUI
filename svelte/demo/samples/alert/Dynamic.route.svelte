...
<button class="btn btn-primary addError" on:click={() => alerts$.add({type: 'danger', slotDefault: 'Error', dismissible: true, animation: true})}
	>Add error</button
>

<button class="btn btn-primary addInfo" on:click={() => alerts$.add({type: 'info', slotDefault: 'Info', dismissible: true, animation: true})}
	>Add info</button
>

<button class="btn btn-primary addWarning" on:click={() => alerts$.add({type: 'warning', slotDefault: 'Warning', dismissible: true, animation: true})}
	>Add warning</button
>
