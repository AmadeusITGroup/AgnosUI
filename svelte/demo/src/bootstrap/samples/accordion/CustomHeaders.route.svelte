		...
		<svelte:fragment slot="itemStructure" let:state let:widget>
			...
			>
				...
				<button
					...
					disabled={state.itemDisabled}>Toggle first</button
				>
			</div>
			...
			>
				...
				<div class="d-flex flex-wrap gap-2">
					<button
						...
						disabled={state.itemDisabled}>Toggle second</button
					>
		...
		<svelte:fragment slot="itemStructure" let:state let:widget>
			...
			>
				<button
					use:widget.directives.toggleDirective
					type="button"
					class="p-0 btn btn-link container-fluid text-start {state.itemButtonClass} au-accordion-item-button"
					disabled={state.itemDisabled}>Third panel</button
				>
