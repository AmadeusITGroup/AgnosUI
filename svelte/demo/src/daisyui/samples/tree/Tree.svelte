	...
	<li role="treeitem">
		<span class="flex flex-wrap items-center" use:itemToggleDirective={{item: treeItem}}>
			...
			{#if treeItem.children.length > 0}
				<span class="ms-auto">
					<svg
						class="transition transform delay-0 duration-300 [.au-tree-expand-icon.au-tree-expand-icon-expanded>span>&]:rotate-180"
						xmlns="http://www.w3.org/2000/svg"
						width="14"
						height="14"
						viewBox="0 0 10 10"><path d="M1 2 L5 7 L9 2" stroke="black" stroke-width="2" fill="none" /></svg
					>
				</span>
			{/if}
		</span>
