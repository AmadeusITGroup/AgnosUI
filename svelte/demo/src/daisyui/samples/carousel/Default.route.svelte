<script lang="ts">
	...
	let loop = true;
	let withNavArrows = true;
	let withNavIndicators = true;
	let dragFree = false;
	let _autoplay = true;
	$: autoplay = loop && _autoplay;
</script>

<div class="w-full flex justify-center">
	<div class="max-w-[600px] self-center">
		<Carousel items={photos} let:prop={photo} {withNavArrows} {withNavIndicators} {loop} {dragFree} {autoplay}>
