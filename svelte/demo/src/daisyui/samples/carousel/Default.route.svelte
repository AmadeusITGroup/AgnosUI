...
<div class="w-full flex justify-center">
	<div class="max-w-[600px] grow">
		<Carousel {showNavigationArrows} {showNavigationIndicators} {loop} {dragFree} {autoplay} direction={rtl ? 'rtl' : 'ltr'}>
			{#each photos as photo, index}
				<Slide>
					<img class="select-none object-contain aspect-[4/3] w-full" alt="picsum photo {index + 1} of 6" src={photo} loading="lazy" />
				</Slide>
			{/each}
		</Carousel>
