...
<script lang="ts">
	...
	const {
		...
		directives: {transitionDirective, toastDirective},
		state$,
	} = widget;
...
{#if !$hidden$}
	<div class="au-toast toast {$state$.className}" role="alert" aria-atomic="true" use:transitionDirective use:toastDirective>
