...
import type {WidgetsConfig as CoreWidgetsConfig} from '@agnos-ui/style-bootstrap/config';
...
const widgetFactories: {
	...
	injectWidgetConfig: <N extends keyof CoreWidgetsConfig>(widgetName: N) => ReadableSignal<Partial<WidgetsConfig[N]> | undefined>;
