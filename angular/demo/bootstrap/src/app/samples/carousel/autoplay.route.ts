import {CarouselComponent, CarouselNavigationDirective, CarouselSlideDirective} from '@agnos-ui/angular-bootstrap';
...
@Component({
	...
	`,
	styles: "@use '@agnos-ui/common/samples/carousel/autoplay.css';",
