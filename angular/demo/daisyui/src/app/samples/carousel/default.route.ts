...
import {SlideDirective} from './slide.component';
...
@Component({
			...
			<div class="max-w-[600px] grow">
				...
				>
					@for (photo of photos; track photo; let index = $index) {
						<div appSlide>
							<img [src]="photo" class="select-none object-contain aspect-[4/3] w-full" alt="picsum photo {{ index + 1 }} of 6" loading="lazy" />
						</div>
					}
				</app-carousel>
	...
	`,
	imports: [CarouselComponent, SlideDirective, FormsModule],
})
