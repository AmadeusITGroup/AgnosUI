...
const TicksDemo = () => {
	...
	return (
		<>
			...
			<Slider min={0} max={100} stepSize={1} values={sliderControl} onValuesChange={setSliderControl} showTicks tickStep={25} />
			<br />
			...
			<p>
				{' '}
				If <i>showTickValues</i> is set to <i>false</i> automatically put the min/max/current label display to <i>true</i>
			</p>
		</>
	);
};
