...
export const CoffeeSlider = (slotContext: SliderContext) => (
	<>
		...
		<button className="coffee-indicator" {...useDirective(slotContext.widget.directives.handleDirective, {item: slotContext.state.sortedHandles[0]})}>
