import type {AlertApi, AlertProps} from '@agnos-ui/react-headless/components/alert';
...
export const Alert = forwardRef(function Alert(
	props: Partial<Pick<AlertProps, 'className' | 'visible' | 'dismissible' | 'ariaCloseButtonLabel'>> & {children?: ReactNode},
