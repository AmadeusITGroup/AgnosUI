...
export function Tree(props: Partial<Pick<TreeProps, 'className' | 'nodes' | 'navSelector'>>) {
	...
	return (
		<ul role="tree" className={classNames('bg-base-200', 'rounded-lg', 'menu', 'w-[300px]', state.className)} {...useDirective(navigationDirective)}>
...
const ToggleButtonDisplay = () => {
	return (
		<span className="ms-auto">
			<svg
				className="transition transform delay-0 duration-300 [.au-tree-expand-icon.au-tree-expand-icon-expanded>span>&]:rotate-180"
				xmlns="http://www.w3.org/2000/svg"
				width="14"
				height="14"
				viewBox="0 0 10 10"
			>
				<path d="M1 2 L5 7 L9 2" stroke="black" strokeWidth="2" fill="none" />
			</svg>
		</span>
	);
};
