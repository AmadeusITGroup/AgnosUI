import {Accordion as AccordionAgnosUI, AccordionItem as AccordionItemAgnosUI} from '@agnos-ui/react';
...
const AccordionDemo = () => {
	return (
		<>
			<AccordionAgnosUI>
				<AccordionItemAgnosUI slotItemHeader="Simple" slotItemBody={body} itemCollapsed={false} />
				<AccordionItemAgnosUI slotItemHeader={fancyHeader} slotItemBody={body} />
				<AccordionItemAgnosUI slotItemHeader="Disabled" slotItemBody={body} itemDisabled={true} />
			</AccordionAgnosUI>
		</>
	);
};
