...
export const Toast = forwardRef(function Toast(props: PropsWithChildren<Partial<ToastProps>>, ref) {
	...
	const refToast = useDirectives([widget.directives.transitionDirective, widget.directives.toastDirective]);
	...
	return (
		<>
			{state.hidden ? null : (
				<div className={`au-toast toast ${state.className}`} role="alert" ref={refToast} aria-atomic="true">
