...
import type {SlotContent as CoreSlotContent, Merge, Widget, WidgetFactory, WidgetProps, WidgetSlotContext, WidgetState} from '@agnos-ui/core/types';
...
export type AdaptSlotContentProps<Props extends Record<string, any>> =
	Props extends WidgetSlotContext<infer U>
		? Merge<WidgetSlotContext<AdaptWidgetSlots<U>>, AdaptPropsSlots<Omit<Props, keyof WidgetSlotContext<any>>>>
		: AdaptPropsSlots<Props>;

export type AdaptPropsSlots<Props> = Merge<
	Omit<Props, `slot${string}`>,
	{
