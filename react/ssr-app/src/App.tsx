...
export const App = () => (
	<div className="container">
		...
		<div className="my-3">
			<Accordion>
				<AccordionItem itemVisible={true} slotItemHeader="First">
					Content 1
				</AccordionItem>
				<AccordionItem slotItemHeader="Second">Content 2</AccordionItem>
				<AccordionItem itemDisabled={true} slotItemHeader="Disabled">
					Content 3
				</AccordionItem>
			</Accordion>
		</div>
