...
export const Progressbar = (props: Partial<ProgressbarProps>) => {
	const {state, api, actions, directives} = useWidgetWithConfig(createProgressbar, props, 'progressbar', defaultConfig);
	const slotContext: ProgressbarContext = {state, api, actions, directives};
	return (
