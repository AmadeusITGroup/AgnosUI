...
export function Slider(props: PropsWithChildren<Partial<SliderProps>>) {
	const {state, api, actions, directives} = useWidgetWithConfig(createSlider, props, 'slider', {...defaultConfig});
	const slotContext: SliderContext = {state, api, actions, directives};

	return (
		<div {...useDirective(directives.sliderDirective)}>
