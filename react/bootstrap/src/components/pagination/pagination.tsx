...
export function Pagination(props: Partial<PaginationProps>) {
	const {state, actions, api, directives} = useWidgetWithConfig(createPagination, props, 'pagination', defaultConfig);
	const slotContext: PaginationContext = {state, actions, api, directives};
