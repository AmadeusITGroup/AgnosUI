import{s as I,e as A,t as T,c as W,b as L,d as k,f as c,m as $,i as d,h as S,j as R,n as x,a as p,r as C,g as m}from"../chunks/scheduler.Bus5bagK.js";import{S as O,i as E,c as g,b as f,m as y,t as w,a as v,e as b}from"../chunks/index.hvgIYORv.js";import{H as _}from"../chunks/Header.BZx8BOAH.js";import{M as F}from"../chunks/Markdown.KMmdT_yu.js";function M(i){let t,r,n;return{c(){t=A("strong"),r=T("Published on "),n=T(i[0]),this.h()},l(a){t=W(a,"STRONG",{class:!0});var s=L(t);r=k(s,"Published on "),n=k(s,i[0]),s.forEach(c),this.h()},h(){$(t,"class","d-flex mb-2")},m(a,s){d(a,t,s),S(t,r),S(t,n)},p(a,[s]){s&1&&R(n,a[0])},i:x,o:x,d(a){a&&c(t)}}}function V(i,t,r){let{date:n}=t;return n=Intl.DateTimeFormat("en-US",{dateStyle:"full"}).format(new Date(n)),i.$$set=a=>{"date"in a&&r(0,n=a.date)},[n]}class q extends O{constructor(t){super(),E(this,t,V,M,I,{date:0})}}const N=`In [AgnosUI](https://www.agnosui.dev/latest/), we employ [Tansu](https://github.com/AmadeusITGroup/tansu) to handle our widget states.
