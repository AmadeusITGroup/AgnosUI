...
for I18n, we suggest to use the global configuration
override any configuration parameters provided for this`,fileName:"core/lib/pagination.ts",start:{line:131,character:2,position:3689},end:{line:131,character:47,position:3734},type:"SlotContent<PaginationContext>",defaultValue:"'‹'"}],t=[{name:"activeLabel",description:`The label for the "active" page.
for I18n, we suggest to use the global configuration
