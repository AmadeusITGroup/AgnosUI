...
import { UseDirective, SlotDirective, ComponentTemplate, callWidgetFactory, toSlotContextWidget, patchSimpleChanges, createAccordion, createModal, mergeDirectives, SlotDefaultDirective, createPagination, createRating, createSelect, createAlert } from '@agnos-ui/angular-headless';
...
class AccordionItemComponent {
    constructor() {
        ...
        this._widget = callWidgetFactory(this.ad.api.registerItem, null, defaultConfig$3);
...
class PaginationComponent {
    constructor() {
        this._widget = callWidgetFactory(createPagination, 'pagination', defaultConfig$1);
        this.widget = toSlotContextWidget(this._widget);
        this.api = this._widget.api;
        /**
