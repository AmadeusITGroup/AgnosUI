<script lang="ts">
	...
	function computedAppliedHref(inputHref: string, url: URL, selectedFwk: string) {
	...
	let appliedHref = $derived(computedAppliedHref(href, page.url, routing.selectedFramework));
</script>
