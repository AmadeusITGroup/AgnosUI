...
<div class={`bg-light-subtle ${className} d-flex flex-nowrap align-items-start py-2  px-2 px-sm-4`}>
	<!-- svelte-ignore a11y-no-noninteractive-tabindex -->
	<pre class="mb-0 align-self-center overflow-x-scroll" tabindex="0"><code bind:this={container}
