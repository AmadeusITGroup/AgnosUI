...
<MobileDialog title="AgnosUI" {open} {onclose}>
	...
	<div class="flex justify-center">
		...
		<a class="ms-3" href="https://twitter.com/AgnosUI" aria-label="link to twitter / x account" target="_blank">
			<Svg className="icon-24 align-middle" svg={twitter} />
		</a>
		<a class="ms-3" href="https://bsky.app/profile/agnosui.bsky.social" aria-label="link to bluesky profile" target="_blank">
